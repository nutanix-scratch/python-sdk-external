...
class DisksApi(object):
        ...
        try:
            if kwargs.get('async_req'):
                return self.api_client._call_api(
                    '/api/clustermgmt/v4.0.b2/config/disks/{extId}', 'GET',
                    path_params,
                    query_params,
                    header_params,
                    body=body_params,
    ...
    def get_disk_stats(self, extId, _startTime, _endTime, _samplingInterval=None, _statType=None, **kwargs):  # noqa: E501
        ...
        try:
            if kwargs.get('async_req'):
                return self.api_client._call_api(
                    '/api/clustermgmt/v4.0.b2/stats/disks/{extId}', 'GET',
                    path_params,
                    query_params,
                    header_params,
                    body=body_params,
    ...
    def list_disks(self, _page=None, _limit=None, _filter=None, _orderby=None, _apply=None, _select=None, **kwargs):  # noqa: E501
        ...
        try:
            if kwargs.get('async_req'):
                return self.api_client._call_api(
                    '/api/clustermgmt/v4.0.b2/config/disks', 'GET',
                    path_params,
                    query_params,
                    header_params,
                    body=body_params,
