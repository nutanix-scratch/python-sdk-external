...
class DataStore(ExternalizableAbstractModel):
    ...
    :param container_name: (:attr:`container_name`) Name of the Storage Container. Note that name of StorageContainer should be unique per cluster.
    :type container_name: 
    :param host_ext_id: (:attr:`host_ext_id`) ExtId of the host for Data Store.
    :type host_ext_id: 
    :param host_ip_address: (:attr:`host_ip_address`) Host IP for Data Store.
    :type host_ip_address: 
    :param capacity_bytes: (:attr:`capacity_bytes`) Maximum physical capacity of the Storage Container in bytes.
    :type capacity_bytes: 
    :param free_space_bytes: (:attr:`free_space_bytes`) The free space in the Data Store.
    :type free_space_bytes: 
    :param vm_names: (:attr:`vm_names`) List of VMs name in the Data Store.
    :type vm_names: 
    ...
    def host_ip_address(self, host_ip_address):
        if host_ip_address is not None and not re.search('#\/components\/schemas\/common.v1.r0.b1.config.IPAddressOrFQDN', host_ip_address):  # noqa: E501
            raise ValueError(r"Invalid value for `host_ip_address`, must be a follow pattern or equal to `/#\/components\/schemas\/common.v1.r0.b1.config.IPAddressOrFQDN/`")  # noqa: E501
