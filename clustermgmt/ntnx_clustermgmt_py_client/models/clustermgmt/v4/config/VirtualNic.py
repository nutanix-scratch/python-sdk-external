...
class VirtualNic(ExternalizableAbstractModel):
    ...
    def __init__(self, name=None, host_description=None, mac_address=None, ipv4_addresses=None, ipv6_addresses=None, interface_status=None, dhcp_enabled=None, link_speed_in_kbps=None, mtu_in_bytes=None, node_uuid=None, vlan_id=None, host_nics_uuids=None, ext_id=None, links=None, tenant_id=None, *args, **kwargs):  # noqa: E501
