...
class StorageContainer(ExternalizableAbstractModel):
    ...
    :param owner_ext_id: (:attr:`owner_ext_id`) extId of the owner.
    :type owner_ext_id: 
    :param name: (:attr:`name`) Name of the Storage Container. Note that name of StorageContainer should be unique per cluster.
    :type name: 
    :param cluster_ext_id: (:attr:`cluster_ext_id`) extId of the Cluster owning the Storage Container.
    :type cluster_ext_id: 
    :param storage_pool_ext_id: (:attr:`storage_pool_ext_id`) extId of the Storage Pool owning the Storage Container instance.
    :type storage_pool_ext_id: 
    :param is_marked_for_removal: (:attr:`is_marked_for_removal`) Indicates if the Storage Container is marked for removal. This field in set when the Storage Container is about to be destroyed.
    ...
    :param logical_explicit_reserved_capacity_bytes: (:attr:`logical_explicit_reserved_capacity_bytes`) Total reserved size (in bytes) of the container (set by Admin). This also accounts for the container's replication factor. The actual reserved capacity of the container will be maximum of explicitReservedCapacity and implicitReservedCapacity.
    :type logical_explicit_reserved_capacity_bytes: 
    :param logical_implicit_reserved_capacity_bytes: (:attr:`logical_implicit_reserved_capacity_bytes`) This is the summation of reservations provisioned on all vdisks in the container. The actual reserved capacity of the container will be maximum of explicitReservedCapacity and implicitReservedCapacity.
    :type logical_implicit_reserved_capacity_bytes: 
    :param logical_advertised_capacity_bytes: (:attr:`logical_advertised_capacity_bytes`) Max capacity of the Container as defined by the user.
    ...
    :param nfs_whitelist_address: (:attr:`nfs_whitelist_address`) List of NFS addresses which needs to be whitelisted.
    :type nfs_whitelist_address: 
    :param is_nfs_whitelist_inherited: (:attr:`is_nfs_whitelist_inherited`) Indicates whether the NFS whitelist is inherited from global config.
    :type is_nfs_whitelist_inherited: 
    :param erasure_code: (:attr:`erasure_code`) 
    :type erasure_code: 
    :param is_inline_ec_enabled: (:attr:`is_inline_ec_enabled`) Indicates whether data written to this container should be inline erasure coded or not. This field is only considered when ErasureCoding is enabled.
    ...
    :param erasure_code_delay_secs: (:attr:`erasure_code_delay_secs`) Delay in performing ErasureCode for the current Container instance.
    ...
    :type on_disk_dedup: 
    :param is_compression_enabled: (:attr:`is_compression_enabled`) Indicates whether the compression is enabled for the Container.
    ...
    :param is_internal: (:attr:`is_internal`) Indicates whether the Container is internal and is managed by Nutanix.
    :type is_internal: 
    :param is_software_encryption_enabled: (:attr:`is_software_encryption_enabled`) Indicates whether the Container instance has software encryption enabled.
    :type is_software_encryption_enabled: 
    :param is_encrypted: (:attr:`is_encrypted`) Indicates whether the Container is encrypted or not.
    :type is_encrypted: 
    :param affinity_host_ext_id: (:attr:`affinity_host_ext_id`) Affinity host Id for RF 1 Storage Container.
    :type affinity_host_ext_id: 
    :param cluster_name: (:attr:`cluster_name`) Corresponding name of the Cluster owning the Storage Container instance.
    :type cluster_name: 
    ...
    def name(self):
        """
        Name of the Storage Container. Note that name of StorageContainer should be unique per cluster.
    ...
    def is_marked_for_removal(self):
        """
        Indicates if the Storage Container is marked for removal. This field in set when the Storage Container is about to be destroyed.
    ...
    def logical_explicit_reserved_capacity_bytes(self):
        """
        Total reserved size (in bytes) of the container (set by Admin). This also accounts for the container's replication factor. The actual reserved capacity of the container will be maximum of explicitReservedCapacity and implicitReservedCapacity.
    ...
    def logical_implicit_reserved_capacity_bytes(self):
        """
        This is the summation of reservations provisioned on all vdisks in the container. The actual reserved capacity of the container will be maximum of explicitReservedCapacity and implicitReservedCapacity.
