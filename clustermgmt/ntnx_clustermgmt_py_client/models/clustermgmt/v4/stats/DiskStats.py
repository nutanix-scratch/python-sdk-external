...
class DiskStats(ExternalizableAbstractModel):
    ...
    :type disk_usage_ppm: 
    :param disk_capacity_bytes: (:attr:`disk_capacity_bytes`) Total amount of storage capacity of a device in bytes.
    :type disk_capacity_bytes: 
    :param disk_num_iops: (:attr:`disk_num_iops`) Number of IO operations that a Disk perform per second.
    :type disk_num_iops: 
    :param disk_peak_num_iops: (:attr:`disk_peak_num_iops`) Upper limit of I/O operations that a Disk perform per second.
    ...
    :param disk_io_bandwidthkbps: (:attr:`disk_io_bandwidthkbps`) IO bandwidth - KB per second.
    ...
    :param disk_base_io_bandwidthkbps: (:attr:`disk_base_io_bandwidthkbps`) Lower limit of data transfer that a Disk can handler per second.
    :type disk_base_io_bandwidthkbps: 
    :param disk_avg_io_latency_microsec: (:attr:`disk_avg_io_latency_microsec`) Average IO latency.
    :type disk_avg_io_latency_microsec: 
    :param disk_peak_io_latency_microsec: (:attr:`disk_peak_io_latency_microsec`) Upper limit of the latency of I/O operations that Disk can handle without exceeding its standard latency level.
    :type disk_peak_io_latency_microsec: 
    :param disk_base_io_latency_microsec: (:attr:`disk_base_io_latency_microsec`) Lower limit of the latency of I/O operations that Disk can handle without exceeding its standard latency level.
    ...
    :param disk_read_iops: (:attr:`disk_read_iops`) Number of read IO per second.
    :type disk_read_iops: 
    ...
    :param disk_write_iops: (:attr:`disk_write_iops`) Number of write IO per second.
    :type disk_write_iops: 
    :param disk_peak_write_iops: (:attr:`disk_peak_write_iops`) Upper buffer capacity of number of write IO per second.
    :type disk_peak_write_iops: 
    :param disk_base_write_iops: (:attr:`disk_base_write_iops`) Lower buffer capacity of number of write IO per second.
    :type disk_base_write_iops: 
    :param disk_read_io_bandwidthkbps: (:attr:`disk_read_io_bandwidthkbps`) Number of Disk read IO per second reported by Stargate.
    :type disk_read_io_bandwidthkbps: 
    :param disk_peak_read_io_bandwidthkbps: (:attr:`disk_peak_read_io_bandwidthkbps`) Upper buffer capacity for the amount of IO bandwidth that a Disk can handle for read operations.
    :type disk_peak_read_io_bandwidthkbps: 
    :param disk_base_read_io_bandwidthkbps: (:attr:`disk_base_read_io_bandwidthkbps`) Lower buffer capacity for the amount of IO bandwidth that a Disk can handle for read operations.
    :type disk_base_read_io_bandwidthkbps: 
    :param disk_write_io_bandwidthkbps: (:attr:`disk_write_io_bandwidthkbps`) Number of Disk write IO per second reported by Stargate.
    :type disk_write_io_bandwidthkbps: 
    :param disk_peak_write_io_bandwidthkbps: (:attr:`disk_peak_write_io_bandwidthkbps`) Upper buffer capacity for the amount of IO bandwidth that a Disk can handle for write operations.
    :type disk_peak_write_io_bandwidthkbps: 
    :param disk_base_write_io_bandwidthkbps: (:attr:`disk_base_write_io_bandwidthkbps`) Lower buffer capacity for the amount of IO bandwidth that a Disk can handle for write operations.
    :type disk_base_write_io_bandwidthkbps: 
    :param disk_read_io_avg_latency_microsec: (:attr:`disk_read_io_avg_latency_microsec`) Average read IO latency, measured in microseconds (usecs).
    :type disk_read_io_avg_latency_microsec: 
    :param disk_peak_read_io_avg_latency_microsec: (:attr:`disk_peak_read_io_avg_latency_microsec`) Upper buffer capacity average read IO latency, measured in microseconds (usecs).
    :type disk_peak_read_io_avg_latency_microsec: 
    :param disk_base_read_io_avg_latency_microsec: (:attr:`disk_base_read_io_avg_latency_microsec`) Lower buffer capacity average read IO latency, measured in microseconds (usecs).
    :type disk_base_read_io_avg_latency_microsec: 
    :param disk_write_io_avg_latency_microsec: (:attr:`disk_write_io_avg_latency_microsec`) Average write IO latency, measured in microseconds (usecs).
    :type disk_write_io_avg_latency_microsec: 
    :param disk_peak_write_io_avg_latency_microsec: (:attr:`disk_peak_write_io_avg_latency_microsec`) Upper buffer capacity average write IO latency, measured in microseconds (usecs).
    :type disk_peak_write_io_avg_latency_microsec: 
    :param disk_base_write_io_avg_latency_microsec: (:attr:`disk_base_write_io_avg_latency_microsec`) Lower buffer capacity average write IO latency, measured in microseconds (usecs).
    :type disk_base_write_io_avg_latency_microsec: 
    :param disk_read_io_ppm: (:attr:`disk_read_io_ppm`) Disk read IO, expressed in parts per million.
    :type disk_read_io_ppm: 
    :param disk_write_io_ppm: (:attr:`disk_write_io_ppm`) Disk write IO, expressed in parts per million.
    ...
    def disk_peak_num_iops(self):
        """
        Upper limit of I/O operations that a Disk perform per second.
    ...
    def disk_peak_read_io_bandwidthkbps(self):
        """
        Upper buffer capacity for the amount of IO bandwidth that a Disk can handle for read operations.
    ...
    def disk_base_read_io_bandwidthkbps(self):
        """
        Lower buffer capacity for the amount of IO bandwidth that a Disk can handle for read operations.
    ...
    def disk_peak_write_io_bandwidthkbps(self):
        """
        Upper buffer capacity for the amount of IO bandwidth that a Disk can handle for write operations.
    ...
    def disk_base_write_io_bandwidthkbps(self):
        """
        Lower buffer capacity for the amount of IO bandwidth that a Disk can handle for write operations.
