...
class StorageContainerStats(ExternalizableAbstractModel):
    ...
    :param controller_num_iops: (:attr:`controller_num_iops`) Number of IO per second.
    :type controller_num_iops: 
    :param controller_io_bandwidthk_bps: (:attr:`controller_io_bandwidthk_bps`) Total IO bandwidth - kB per second.
    :type controller_io_bandwidthk_bps: 
    :param controller_avg_io_latencyu_secs: (:attr:`controller_avg_io_latencyu_secs`) Average IO latency in micro secs.
    :type controller_avg_io_latencyu_secs: 
    :param controller_num_read_iops: (:attr:`controller_num_read_iops`) Number of read IO per second.
    :type controller_num_read_iops: 
    :param controller_num_write_iops: (:attr:`controller_num_write_iops`) Number of write IO per second.
    :type controller_num_write_iops: 
    :param controller_read_io_bandwidthk_bps: (:attr:`controller_read_io_bandwidthk_bps`) Read IO bandwidth - kB per second.
    :type controller_read_io_bandwidthk_bps: 
    :param controller_write_io_bandwidthk_bps: (:attr:`controller_write_io_bandwidthk_bps`) Write IO bandwidth - kB per second.
    :type controller_write_io_bandwidthk_bps: 
    :param controller_avg_read_io_latencyu_secs: (:attr:`controller_avg_read_io_latencyu_secs`) Average read IO latency in micro seconds.
    :type controller_avg_read_io_latencyu_secs: 
    :param controller_avg_write_io_latencyu_secs: (:attr:`controller_avg_write_io_latencyu_secs`) Average read IO latency in micro seconds.
    ...
    :param data_reduction_compression_saving_ratio_ppm: (:attr:`data_reduction_compression_saving_ratio_ppm`) Saving ratio in PPM as a result of Compression technique.
    :type data_reduction_compression_saving_ratio_ppm: 
    :param data_reduction_dedup_saving_ratio_ppm: (:attr:`data_reduction_dedup_saving_ratio_ppm`) Saving ratio in PPM as a result of Deduplication technique.
    :type data_reduction_dedup_saving_ratio_ppm: 
    :param data_reduction_erasure_coding_saving_ratio_ppm: (:attr:`data_reduction_erasure_coding_saving_ratio_ppm`) Saving ratio in PPM as a result of Erasure Coding technique.
    :type data_reduction_erasure_coding_saving_ratio_ppm: 
    :param data_reduction_thin_provision_saving_ratio_ppm: (:attr:`data_reduction_thin_provision_saving_ratio_ppm`) Saving ratio in PPM as a result of Thin Provisioning technique.
    :type data_reduction_thin_provision_saving_ratio_ppm: 
    :param data_reduction_clone_saving_ratio_ppm: (:attr:`data_reduction_clone_saving_ratio_ppm`) Saving ratio in PPM as a result of Cloning technique.
    ...
    :param controller_read_io_ratio_ppm: (:attr:`controller_read_io_ratio_ppm`) Ratio of read IO to total IO in PPM.
    :type controller_read_io_ratio_ppm: 
    :param controller_write_io_ratio_ppm: (:attr:`controller_write_io_ratio_ppm`) Ratio of read IO to total IO in PPM.
    ...
    :param health: (:attr:`health`) Health of the container represented by integer value in range 0-100. Higher value is an indicative of better health.
    :type health: 
    ...
    def controller_io_bandwidthk_bps(self):
        """
        Total IO bandwidth - kB per second.
    ...
    def controller_avg_io_latencyu_secs(self):
        """
        Average IO latency in micro secs.
    ...
    def controller_read_io_bandwidthk_bps(self):
        """
        Read IO bandwidth - kB per second.
    ...
    def controller_write_io_bandwidthk_bps(self):
        """
        Write IO bandwidth - kB per second.
    ...
    def controller_avg_read_io_latencyu_secs(self):
        """
        Average read IO latency in micro seconds.
    ...
    def data_reduction_compression_saving_ratio_ppm(self):
        """
        Saving ratio in PPM as a result of Compression technique.
    ...
    def data_reduction_dedup_saving_ratio_ppm(self):
        """
        Saving ratio in PPM as a result of Deduplication technique.
    ...
    def data_reduction_erasure_coding_saving_ratio_ppm(self):
        """
        Saving ratio in PPM as a result of Erasure Coding technique.
    ...
    def data_reduction_thin_provision_saving_ratio_ppm(self):
        """
        Saving ratio in PPM as a result of Thin Provisioning technique.
    ...
    def data_reduction_clone_saving_ratio_ppm(self):
        """
        Saving ratio in PPM as a result of Cloning technique.
    ...
    def controller_read_io_ratio_ppm(self):
        """
        Ratio of read IO to total IO in PPM.
    ...
    def health(self):
        """
        Health of the container represented by integer value in range 0-100. Higher value is an indicative of better health.
