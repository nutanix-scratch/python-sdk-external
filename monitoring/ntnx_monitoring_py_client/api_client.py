...
from ntnx_monitoring_py_client import rest
...
class ApiClient(object):
    ...
    # Populated if multiple schemas exist with the same name
        ...
        'monitoring.v4.common.BoolValue' : 'BoolValue',
        'OneOfmonitoring.v4.serviceability.ManageAlertApiResponsedata' : 'ManageAlertApiResponsedata',
        'common.v1.config.FQDN' : 'FQDN',
        'common.v1.config.IPv6Address' : 'IPv6Address',
        'monitoring.v4.serviceability.EventEntityReference' : 'EventEntityReference',
        'monitoring.v4.common.ConditionType' : 'ConditionType',
        'common.v1.config.Flag' : 'Flag',
        'monitoring.v4.common.CauseAndResolution' : 'CauseAndResolution',
        'monitoring.v4.serviceability.ProxyType' : 'ProxyType',
        'monitoring.v4.serviceability.UserDefinedPolicy' : 'UserDefinedPolicy',
        'monitoring.v4.serviceability.AlertDbProjection' : 'AlertDbProjection',
        'monitoring.v4.serviceability.FindConflictingUdaPoliciesApiResponse' : 'FindConflictingUdaPoliciesApiResponse',
        'monitoring.v4.serviceability.SeverityTrail' : 'SeverityTrail',
        'prism.v4.config.TaskReference' : 'TaskReference',
        'monitoring.v4.serviceability.GroupEntityType' : 'GroupEntityType',
        'monitoring.v4.serviceability.ManageAlertsApiResponse' : 'ManageAlertsApiResponse',
        'monitoring.v4.serviceability.GetAlertApiResponse' : 'GetAlertApiResponse',
        'monitoring.v4.serviceability.RootCauseAnalysisProjection' : 'RootCauseAnalysisProjection',
        'monitoring.v4.serviceability.AutoResolve' : 'AutoResolve',
        'monitoring.v4.serviceability.AuditDb' : 'AuditDb',
        'OneOfmonitoring.v4.serviceability.DeleteUdaPolicyApiResponsedata' : 'DeleteUdaPolicyApiResponsedata',
        'monitoring.v4.serviceability.Audit' : 'Audit',
        'OneOfmonitoring.v4.serviceability.GetAlertApiResponsedata' : 'GetAlertApiResponsedata',
        'monitoring.v4.serviceability.RootCauseAnalysis' : 'RootCauseAnalysis',
        'monitoring.v4.common.DoubleValue' : 'DoubleValue',
        'monitoring.v4.error.SchemaValidationErrorMessage' : 'SchemaValidationErrorMessage',
        'monitoring.v4.serviceability.Status' : 'Status',
        'monitoring.v4.common.AlertEntityReference' : 'AlertEntityReference',
        'monitoring.v4.serviceability.CreateUdaPolicyApiResponse' : 'CreateUdaPolicyApiResponse',
        'monitoring.v4.serviceability.GetAuditApiResponse' : 'GetAuditApiResponse',
        'monitoring.v4.common.Severity' : 'Severity',
        'monitoring.v4.serviceability.EmailTemplate' : 'EmailTemplate',
        'monitoring.v4.error.ErrorResponse' : 'ErrorResponse',
        'monitoring.v4.serviceability.DeleteUdaPolicyApiResponse' : 'DeleteUdaPolicyApiResponse',
        'monitoring.v4.serviceability.ListEventsApiResponse' : 'ListEventsApiResponse',
        'OneOfmonitoring.v4.serviceability.ListUdaPoliciesApiResponsedata' : 'ListUdaPoliciesApiResponsedata',
        'monitoring.v4.serviceability.HttpProxy' : 'HttpProxy',
        'monitoring.v4.common.OperationType' : 'OperationType',
        'common.v1.config.IPAddressOrFQDN' : 'IPAddressOrFQDN',
        'monitoring.v4.serviceability.ListAlertsApiResponse' : 'ListAlertsApiResponse',
        'monitoring.v4.serviceability.ConflictingPolicy' : 'ConflictingPolicy',
        'monitoring.v4.serviceability.ActionType' : 'ActionType',
        'monitoring.v4.serviceability.Condition' : 'Condition',
        'common.v1.response.ApiResponseMetadata' : 'ApiResponseMetadata',
        'monitoring.v4.serviceability.UpdateUdaPolicyApiResponse' : 'UpdateUdaPolicyApiResponse',
        'monitoring.v4.serviceability.RemoteTunnelDetails' : 'RemoteTunnelDetails',
        'OneOfmonitoring.v4.serviceability.ListAuditsApiResponsedata' : 'ListAuditsApiResponsedata',
        'monitoring.v4.serviceability.GetUdaPolicyApiResponse' : 'GetUdaPolicyApiResponse',
        'OneOfmonitoring.v4.serviceability.UserDefinedPolicyfilters' : 'UserDefinedPolicyfilters',
        'monitoring.v4.common.EntityReference' : 'EntityReference',
        'monitoring.v4.serviceability.UpdateSdaPolicyApiResponse' : 'UpdateSdaPolicyApiResponse',
        'common.v1.response.ExternalizableAbstractModel' : 'ExternalizableAbstractModel',
        'monitoring.v4.serviceability.ListUdaPoliciesApiResponse' : 'ListUdaPoliciesApiResponse',
        'OneOfmonitoring.v4.serviceability.UpdateUdaPolicyApiResponsedata' : 'UpdateUdaPolicyApiResponsedata',
        'common.v1.config.Message' : 'Message',
        'monitoring.v4.serviceability.TriggerCondition' : 'TriggerCondition',
        'monitoring.v4.serviceability.RelatedPolicy' : 'RelatedPolicy',
        'monitoring.v4.serviceability.EventDbProjection' : 'EventDbProjection',
        'monitoring.v4.common.IntValue' : 'IntValue',
        'OneOfmonitoring.v4.serviceability.ListAlertsApiResponsedata' : 'ListAlertsApiResponsedata',
        'monitoring.v4.serviceability.UserReference' : 'UserReference',
        'OneOfcommon.v1.config.KVPairvalue' : 'KVPairvalue',
        'monitoring.v4.error.AppMessage' : 'AppMessage',
        'monitoring.v4.serviceability.SeverityThresholdInfo' : 'SeverityThresholdInfo',
        'OneOfmonitoring.v4.serviceability.GetUdaPolicyApiResponsedata' : 'GetUdaPolicyApiResponsedata',
        'monitoring.v4.serviceability.EventDb' : 'EventDb',
        'OneOfmonitoring.v4.serviceability.GetAlertEmailConfigurationApiResponsedata' : 'GetAlertEmailConfigurationApiResponsedata',
        'monitoring.v4.serviceability.GroupFilter' : 'GroupFilter',
        'OneOfmonitoring.v4.serviceability.ManageAlertsApiResponsedata' : 'ManageAlertsApiResponsedata',
        'monitoring.v4.common.ImpactType' : 'ImpactType',
        'OneOfmonitoring.v4.common.MetricDetailthreshold_value' : 'MetricDetailthreshold_value',
        'common.v1.config.MessageSeverity' : 'MessageSeverity',
        'monitoring.v4.common.MetricDetail' : 'MetricDetail',
        'monitoring.v4.serviceability.EmailConfigurationRule' : 'EmailConfigurationRule',
        'monitoring.v4.serviceability.AuditDbProjection' : 'AuditDbProjection',
        'OneOfmonitoring.v4.common.Parameterparam_value' : 'Parameterparam_value',
        'monitoring.v4.serviceability.AlertEmailConfiguration' : 'AlertEmailConfiguration',
        'monitoring.v4.common.ComparisonOperator' : 'ComparisonOperator',
        'OneOfmonitoring.v4.serviceability.GetEventApiResponsedata' : 'GetEventApiResponsedata',
        'common.v1.response.ApiLink' : 'ApiLink',
        'monitoring.v4.serviceability.AlertConfigExceptionGroup' : 'AlertConfigExceptionGroup',
        'monitoring.v4.common.Parameter' : 'Parameter',
        'monitoring.v4.serviceability.AlertDb' : 'AlertDb',
        'OneOfmonitoring.v4.error.ErrorResponseerror' : 'ErrorResponseerror',
        'monitoring.v4.serviceability.Alert' : 'Alert',
        'monitoring.v4.serviceability.PolicySeverityLevel' : 'PolicySeverityLevel',
        'OneOfmonitoring.v4.serviceability.UpdateSdaPolicyApiResponsedata' : 'UpdateSdaPolicyApiResponsedata',
        'monitoring.v4.serviceability.Event' : 'Event',
        'monitoring.v4.error.SchemaValidationError' : 'SchemaValidationError',
        'monitoring.v4.serviceability.EntityFilter' : 'EntityFilter',
        'monitoring.v4.serviceability.GetAlertEmailConfigurationApiResponse' : 'GetAlertEmailConfigurationApiResponse',
        'monitoring.v4.common.DataType' : 'DataType',
        'monitoring.v4.serviceability.AuditEntityReference' : 'AuditEntityReference',
        'OneOfmonitoring.v4.serviceability.GetAuditApiResponsedata' : 'GetAuditApiResponsedata',
        'monitoring.v4.serviceability.ManageAlertApiResponse' : 'ManageAlertApiResponse',
        'monitoring.v4.serviceability.AlertActionSpec' : 'AlertActionSpec',
        'OneOfmonitoring.v4.serviceability.FindConflictingUdaPoliciesApiResponsedata' : 'FindConflictingUdaPoliciesApiResponsedata',
        'monitoring.v4.serviceability.CommunicationStatus' : 'CommunicationStatus',
        'monitoring.v4.serviceability.ServiceCenter' : 'ServiceCenter',
        'OneOfmonitoring.v4.serviceability.ListEventsApiResponsedata' : 'ListEventsApiResponsedata',
        'OneOfmonitoring.v4.common.MetricDetailmetric_value' : 'MetricDetailmetric_value',
        'monitoring.v4.serviceability.ConnectionStatus' : 'ConnectionStatus',
        'monitoring.v4.common.StringValue' : 'StringValue',
        'common.v1.config.TenantAwareModel' : 'TenantAwareModel',
        'OneOfmonitoring.v4.serviceability.UpdateAlertEmailConfigurationApiResponsedata' : 'UpdateAlertEmailConfigurationApiResponsedata',
        'monitoring.v4.serviceability.ParameterizedMessage' : 'ParameterizedMessage',
        'OneOfmonitoring.v4.serviceability.Conditionthreshold_value' : 'Conditionthreshold_value',
        'monitoring.v4.serviceability.ListAuditsApiResponse' : 'ListAuditsApiResponse',
        'monitoring.v4.serviceability.UpdateAlertEmailConfigurationApiResponse' : 'UpdateAlertEmailConfigurationApiResponse',
        'common.v1.config.KVStringPair' : 'KVStringPair',
        'OneOfmonitoring.v4.serviceability.CreateUdaPolicyApiResponsedata' : 'CreateUdaPolicyApiResponsedata',
        'common.v1.config.KVPair' : 'KVPair',
        'monitoring.v4.serviceability.GetEventApiResponse' : 'GetEventApiResponse'
    }
    ...
    def __call_api(
        ...
        if response_data.status == 401:
            ...
            if response_data.status == 401:
                raise ntnx_monitoring_py_client.rest.ApiException(http_resp=response_data)
    ...
    def __deserialize_response(self, response, response_type):
        ...
        :type response: :class:`~ntnx_monitoring_py_client.rest.RESTResponse`, required
    ...
    def _call_api(self, resource_path, method,
        ...
        :param _request_timeout: Timeout setting for this request. It needs to be a pair (list) of
            ...
            the timeouts will be derived from the :class:`~ntnx_monitoring_py_client.configuration.Configuration`.
    ...
    def __deserialize_file(self, response):
        ...
        :param response: :class:`~ntnx_monitoring_py_client.rest.RESTResponse`
        :return: File path
        """
    ...
    def __deserialize_date(self, string):
        ...
        :param string:
        :type string: str
        :raises :class:`~ntnx_monitoring_py_client.rest.ApiException` if provided string is not a valid date
        :return: date object
        """
        try:
    ...
    def __deserialize_datatime(self, string):
        ...
        :raises :class:`~ntnx_monitoring_py_client.rest.ApiException` if provided string is not a valid datetime
    ...
    def __getattr(self, name):
        if name in self.DUPLICATE_SCHEMA_MAPPING:
            return getattr(ntnx_monitoring_py_client.models, self.DUPLICATE_SCHEMA_MAPPING[name])
        if hasattr(ntnx_monitoring_py_client.models, name.split('.')[-1]):
            return getattr(ntnx_monitoring_py_client.models, name.split('.')[-1])
        else:
            return getattr(ntnx_monitoring_py_client.models, name)
