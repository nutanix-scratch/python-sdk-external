...
class AuthorizationPolicyType(object):
    ...
    def _initialize_object_type(self):
        return 'iam.v4.authz.AuthorizationPolicyType'
        ...
        for attr in vars(self):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(AuthorizationPolicyType, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, AuthorizationPolicyType):
            return False
