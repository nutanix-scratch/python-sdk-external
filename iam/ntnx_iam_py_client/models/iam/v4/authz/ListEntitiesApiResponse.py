...
from ntnx_iam_py_client.models.OneOfiam.v4.authz.ListEntitiesApiResponsedata import ListEntitiesApiResponsedata  # noqa: F401,E501
from ntnx_iam_py_client.models.common.v1.response.ApiResponseMetadata import ApiResponseMetadata  # noqa: F401,E501

class ListEntitiesApiResponse(object):
    ...
    swagger_types = {
        ...
        'data': 'OneOfiam.v4.authz.ListEntitiesApiResponsedata',
    ...
    def _initialize_object_type(self):
        return 'iam.v4.authz.ListEntitiesApiResponse'
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(ListEntitiesApiResponse, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ListEntitiesApiResponse):
            return False
