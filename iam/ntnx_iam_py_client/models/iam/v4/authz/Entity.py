...
class Entity(ExternalizableAbstractModel):
    ...
    :type attribute_list: 
    :param unique_id: (:attr:`unique_id`) Unique Identifier of a client entity.
    :type unique_id: 
    ...
    def __init__(self, name=None, description=None, display_name=None, client_name=None, search_url=None, created_time=None, last_updated_time=None, created_by=None, attribute_list=None, unique_id=None, ext_id=None, links=None, tenant_id=None, *args, **kwargs):  # noqa: E501
