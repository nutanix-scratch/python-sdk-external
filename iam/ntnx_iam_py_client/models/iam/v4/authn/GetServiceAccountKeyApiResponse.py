...
from ntnx_iam_py_client.models.OneOfiam.v4.authn.GetServiceAccountKeyApiResponsedata import GetServiceAccountKeyApiResponsedata  # noqa: F401,E501
from ntnx_iam_py_client.models.common.v1.response.ApiResponseMetadata import ApiResponseMetadata  # noqa: F401,E501

class GetServiceAccountKeyApiResponse(object):
    ...
    swagger_types = {
        ...
        'data': 'OneOfiam.v4.authn.GetServiceAccountKeyApiResponsedata',
    ...
    def _initialize_object_type(self):
        return 'iam.v4.authn.GetServiceAccountKeyApiResponse'
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(GetServiceAccountKeyApiResponse, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, GetServiceAccountKeyApiResponse):
            return False
