...
from ntnx_iam_py_client.models.OneOfiam.v4.authn.ListUserBucketKeysApiResponsedata import ListUserBucketKeysApiResponsedata  # noqa: F401,E501
from ntnx_iam_py_client.models.common.v1.response.ApiResponseMetadata import ApiResponseMetadata  # noqa: F401,E501

class ListUserBucketKeysApiResponse(object):
    ...
    swagger_types = {
        ...
        'data': 'OneOfiam.v4.authn.ListUserBucketKeysApiResponsedata',
    ...
    def _initialize_object_type(self):
        return 'iam.v4.authn.ListUserBucketKeysApiResponse'
    ...
    def data(self):
        ...
        :type:
                :class:`~ntnx_iam_py_client.models.iam.v4.authn.BucketsAccessKey` | 
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(ListUserBucketKeysApiResponse, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ListUserBucketKeysApiResponse):
            return False
