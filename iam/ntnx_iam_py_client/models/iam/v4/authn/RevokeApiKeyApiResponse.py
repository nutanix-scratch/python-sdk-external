...
from ntnx_iam_py_client.models.OneOfiam.v4.authn.RevokeApiKeyApiResponsedata import RevokeApiKeyApiResponsedata  # noqa: F401,E501
from ntnx_iam_py_client.models.common.v1.response.ApiResponseMetadata import ApiResponseMetadata  # noqa: F401,E501

class RevokeApiKeyApiResponse(object):
    ...
    swagger_types = {
        ...
        'data': 'OneOfiam.v4.authn.RevokeApiKeyApiResponsedata',
    ...
    def _initialize_object_type(self):
        return 'iam.v4.authn.RevokeApiKeyApiResponse'
    ...
    def data(self):
        ...
        :type:
                :class:`~ntnx_iam_py_client.models.iam.v4.authn.ApiKeyRevokeResponse` | 
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(RevokeApiKeyApiResponse, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, RevokeApiKeyApiResponse):
            return False
