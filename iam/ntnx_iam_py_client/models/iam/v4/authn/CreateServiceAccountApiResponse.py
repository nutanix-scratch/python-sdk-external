...
from ntnx_iam_py_client.models.OneOfiam.v4.authn.CreateServiceAccountApiResponsedata import CreateServiceAccountApiResponsedata  # noqa: F401,E501
from ntnx_iam_py_client.models.common.v1.response.ApiResponseMetadata import ApiResponseMetadata  # noqa: F401,E501

class CreateServiceAccountApiResponse(object):
    ...
    swagger_types = {
        ...
        'data': 'OneOfiam.v4.authn.CreateServiceAccountApiResponsedata',
    ...
    def _initialize_object_type(self):
        return 'iam.v4.authn.CreateServiceAccountApiResponse'
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(CreateServiceAccountApiResponse, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, CreateServiceAccountApiResponse):
            return False
