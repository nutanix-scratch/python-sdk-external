...
class ListServiceAccountKeysApiResponsedata(object):
    ...
    discriminator_value_class_map = {
        ...
        'List<iam.v4.authn.ServiceAccountKey>': 'list[iam.v4.authn.ServiceAccountKey]',
    ...
    def _initialize_object_type(self):
        return 'OneOfiam.v4.authn.ListServiceAccountKeysApiResponsedata'
    ...
    def get_discriminator_from_object(value):
        ...
        if disc in ListServiceAccountKeysApiResponsedata.discriminator_value_class_map.values():
            return list(ListServiceAccountKeysApiResponsedata.discriminator_value_class_map.keys())[list(ListServiceAccountKeysApiResponsedata.discriminator_value_class_map.values()).index(disc)]
        return None
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(ListServiceAccountKeysApiResponsedata, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ListServiceAccountKeysApiResponsedata):
            return False
