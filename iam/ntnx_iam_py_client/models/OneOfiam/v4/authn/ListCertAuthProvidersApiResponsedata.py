...
class ListCertAuthProvidersApiResponsedata(object):
    ...
    def _initialize_object_type(self):
        return 'OneOfiam.v4.authn.ListCertAuthProvidersApiResponsedata'
    ...
    def get_discriminator_from_object(value):
        ...
        if disc in ListCertAuthProvidersApiResponsedata.discriminator_value_class_map.values():
            return list(ListCertAuthProvidersApiResponsedata.discriminator_value_class_map.keys())[list(ListCertAuthProvidersApiResponsedata.discriminator_value_class_map.values()).index(disc)]
        return None
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(ListCertAuthProvidersApiResponsedata, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ListCertAuthProvidersApiResponsedata):
            return False
