...
class DeleteApiKeyApiResponsedata(object):
    ...
    def _initialize_object_type(self):
        return 'OneOfiam.v4.authn.DeleteApiKeyApiResponsedata'
    ...
    def get_discriminator_from_object(value):
        ...
        if disc in DeleteApiKeyApiResponsedata.discriminator_value_class_map.values():
            return list(DeleteApiKeyApiResponsedata.discriminator_value_class_map.keys())[list(DeleteApiKeyApiResponsedata.discriminator_value_class_map.values()).index(disc)]
        return None
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(DeleteApiKeyApiResponsedata, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, DeleteApiKeyApiResponsedata):
            return False
