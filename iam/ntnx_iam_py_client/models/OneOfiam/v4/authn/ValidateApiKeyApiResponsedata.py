...
class ValidateApiKeyApiResponsedata(object):
    ...
    discriminator_value_class_map = {
        ...
        'iam.v4.authn.ApiKeyValidateResponse': 'iam.v4.authn.ApiKeyValidateResponse',
    ...
    def _initialize_object_type(self):
        return 'OneOfiam.v4.authn.ValidateApiKeyApiResponsedata'
    ...
    def get_discriminator_from_object(value):
        ...
        if disc in ValidateApiKeyApiResponsedata.discriminator_value_class_map.values():
            return list(ValidateApiKeyApiResponsedata.discriminator_value_class_map.keys())[list(ValidateApiKeyApiResponsedata.discriminator_value_class_map.values()).index(disc)]
        return None
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(ValidateApiKeyApiResponsedata, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ValidateApiKeyApiResponsedata):
            return False
