...
class DeleteServiceAccountKeyApiResponsedata(object):
    ...
    def _initialize_object_type(self):
        return 'OneOfiam.v4.authn.DeleteServiceAccountKeyApiResponsedata'
    ...
    def get_discriminator_from_object(value):
        ...
        if disc in DeleteServiceAccountKeyApiResponsedata.discriminator_value_class_map.values():
            return list(DeleteServiceAccountKeyApiResponsedata.discriminator_value_class_map.keys())[list(DeleteServiceAccountKeyApiResponsedata.discriminator_value_class_map.values()).index(disc)]
        return None
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(DeleteServiceAccountKeyApiResponsedata, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, DeleteServiceAccountKeyApiResponsedata):
            return False
