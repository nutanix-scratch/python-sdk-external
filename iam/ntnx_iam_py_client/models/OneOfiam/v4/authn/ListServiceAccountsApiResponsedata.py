...
class ListServiceAccountsApiResponsedata(object):
    ...
    discriminator_value_class_map = {
        ...
        'List<iam.v4.authn.ServiceAccount>': 'list[iam.v4.authn.ServiceAccount]',
    ...
    def _initialize_object_type(self):
        return 'OneOfiam.v4.authn.ListServiceAccountsApiResponsedata'
    ...
    def get_discriminator_from_object(value):
        ...
        if disc in ListServiceAccountsApiResponsedata.discriminator_value_class_map.values():
            return list(ListServiceAccountsApiResponsedata.discriminator_value_class_map.keys())[list(ListServiceAccountsApiResponsedata.discriminator_value_class_map.values()).index(disc)]
        return None
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(ListServiceAccountsApiResponsedata, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ListServiceAccountsApiResponsedata):
            return False
