...
class RevokeApiKeyApiResponsedata(object):
    ...
    discriminator_value_class_map = {
        ...
        'iam.v4.authn.ApiKeyRevokeResponse': 'iam.v4.authn.ApiKeyRevokeResponse',
    ...
    def _initialize_object_type(self):
        return 'OneOfiam.v4.authn.RevokeApiKeyApiResponsedata'
    ...
    def get_discriminator_from_object(value):
        ...
        if disc in RevokeApiKeyApiResponsedata.discriminator_value_class_map.values():
            return list(RevokeApiKeyApiResponsedata.discriminator_value_class_map.keys())[list(RevokeApiKeyApiResponsedata.discriminator_value_class_map.values()).index(disc)]
        return None
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(RevokeApiKeyApiResponsedata, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, RevokeApiKeyApiResponsedata):
            return False
