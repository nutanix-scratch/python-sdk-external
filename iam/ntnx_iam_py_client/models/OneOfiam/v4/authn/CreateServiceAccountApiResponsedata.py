...
class CreateServiceAccountApiResponsedata(object):
    ...
    discriminator_value_class_map = {
        ...
        'iam.v4.authn.ServiceAccount': 'iam.v4.authn.ServiceAccount',
    ...
    def _initialize_object_type(self):
        return 'OneOfiam.v4.authn.CreateServiceAccountApiResponsedata'
    ...
    def get_discriminator_from_object(value):
        ...
        if disc in CreateServiceAccountApiResponsedata.discriminator_value_class_map.values():
            return list(CreateServiceAccountApiResponsedata.discriminator_value_class_map.keys())[list(CreateServiceAccountApiResponsedata.discriminator_value_class_map.values()).index(disc)]
        return None
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(CreateServiceAccountApiResponsedata, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, CreateServiceAccountApiResponsedata):
            return False
