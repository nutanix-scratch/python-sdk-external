...
class DeleteAuthorizationPolicyApiResponsedata(object):
    ...
    def _initialize_object_type(self):
        return 'OneOfiam.v4.authz.DeleteAuthorizationPolicyApiResponsedata'
    ...
    def get_discriminator_from_object(value):
        ...
        if disc in DeleteAuthorizationPolicyApiResponsedata.discriminator_value_class_map.values():
            return list(DeleteAuthorizationPolicyApiResponsedata.discriminator_value_class_map.keys())[list(DeleteAuthorizationPolicyApiResponsedata.discriminator_value_class_map.values()).index(disc)]
        return None
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(DeleteAuthorizationPolicyApiResponsedata, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, DeleteAuthorizationPolicyApiResponsedata):
            return False
