...
class GetClientApiResponsedata(object):
    ...
    discriminator_value_class_map = {
        ...
        'iam.v4.authz.Client': 'iam.v4.authz.Client',
    ...
    def _initialize_object_type(self):
        return 'OneOfiam.v4.authz.GetClientApiResponsedata'
    ...
    def get_discriminator_from_object(value):
        ...
        if disc in GetClientApiResponsedata.discriminator_value_class_map.values():
            return list(GetClientApiResponsedata.discriminator_value_class_map.keys())[list(GetClientApiResponsedata.discriminator_value_class_map.values()).index(disc)]
        return None
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(GetClientApiResponsedata, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, GetClientApiResponsedata):
            return False
