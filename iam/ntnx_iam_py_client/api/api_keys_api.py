...
class ApiKeysApi(object):
    ...
    def validate_api_key(self, body=None, **kwargs):  # noqa: E501
        """Validate API key

        >>> response = api.validate_api_key((optional) body)

        This method makes a synchronous HTTP request by default. To make an asynchronous HTTP request, please pass async_req=True.

        >>> thread = api.validate_api_key(async_req=True)
        >>> result = thread.get()

        :param body: Validate API key.
        :type body:

            :class:`~ntnx_iam_py_client.models.iam.v4.authn.ApiKeyValidateRequest`
        :param kwargs: kwargs for the method.
                       The following can be passed for an asynchronous HTTP call::

                           async_req=True
        :return: An instance of class :class:`~ntnx_iam_py_client.models.iam.v4.authn.ValidateApiKeyApiResponse`.
        ...
        try:
            if kwargs.get('async_req'):
                return self.api_client._call_api(
                    '/api/iam/v4.0.b1/authn/api-keys/$actions/validate', 'POST',
                    path_params,
                    query_params,
                    header_params,
                    body=body_params,
                    ...
                    response_type='iam.v4.authn.ValidateApiKeyApiResponse',  # noqa: E501
