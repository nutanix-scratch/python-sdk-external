...
class RESTClientObject(object):
    ...
    def __init__(self, configuration, pools_size=4, maxsize=None, max_retry_attempts=5, backoff_factor=3):
        ...
        # retry mechanism
        retries = urllib3.util.Retry(total=None, status=max_retry_attempts, read=0, connect=0, other=0, status_forcelist=[408, 503, 504], backoff_factor=backoff_factor, raise_on_status=False)
