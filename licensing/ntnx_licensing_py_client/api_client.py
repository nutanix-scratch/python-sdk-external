...
class ApiClient(object):
    ...
    # Populated if multiple schemas exist with the same name
        ...
        'licensing.v4.config.SubCategoryEnum' : 'SubCategoryEnum',
        'licensing.v4.config.FeatureDetail' : 'FeatureDetail',
        'licensing.v4.config.ServiceProjection' : 'ServiceProjection',
        'OneOflicensing.v4.config.GetClusterEntitlementApiResponsedata' : 'GetClusterEntitlementApiResponsedata',
        ...
        'licensing.v4.config.NutanixClusterConfig' : 'NutanixClusterConfig',
        'OneOfcommon.v1.config.KVPairvalue' : 'KVPairvalue',
        'licensing.v4.config.ClusterTypeEnum' : 'ClusterTypeEnum',
        'licensing.v4.config.GetClusterEntitlementApiResponse' : 'GetClusterEntitlementApiResponse',
        'licensing.v4.config.ProductNameEnum' : 'ProductNameEnum',
        'licensing.v4.config.EnforcementPolicyEnum' : 'EnforcementPolicyEnum',
        'common.v1.config.Flag' : 'Flag',
        'licensing.v4.config.ClusterAllowance' : 'ClusterAllowance',
        'licensing.v4.config.EntitlementDetailProjection' : 'EntitlementDetailProjection',
        'OneOflicensing.v4.config.ListClusterEntitlementsApiResponsedata' : 'ListClusterEntitlementsApiResponsedata',
        ...
        'OneOflicensing.v4.config.GetLicenseApiResponsedata' : 'GetLicenseApiResponsedata',
        'licensing.v4.config.MeterEnum' : 'MeterEnum',
        'common.v1.config.MessageSeverity' : 'MessageSeverity',
        'licensing.v4.config.Service' : 'Service',
        'OneOflicensing.v4.config.GetComplianceApiResponsedata' : 'GetComplianceApiResponsedata',
        ...
        'licensing.v4.config.ClusterEntitlement' : 'ClusterEntitlement',
        'licensing.v4.config.ResetScopeEnum' : 'ResetScopeEnum',
        ...
        'licensing.v4.config.ClusterEntitlementProjection' : 'ClusterEntitlementProjection',
        ...
        'licensing.v4.config.GetLicenseApiResponse' : 'GetLicenseApiResponse',
        'licensing.v4.agreements.EulaUser' : 'EulaUser',
        'OneOflicensing.v4.error.ErrorResponseerror' : 'ErrorResponseerror',
        'licensing.v4.config.StatusEnum' : 'StatusEnum',
        'licensing.v4.config.GetClusterAllowanceApiResponse' : 'GetClusterAllowanceApiResponse',
        'licensing.v4.agreements.UpdateEulaApiResponse' : 'UpdateEulaApiResponse',
        'OneOflicensing.v4.config.GetClusterAllowanceApiResponsedata' : 'GetClusterAllowanceApiResponsedata',
        'licensing.v4.config.GetSettingApiResponse' : 'GetSettingApiResponse',
        ...
        'OneOflicensing.v4.config.GetClusterViolationApiResponsedata' : 'GetClusterViolationApiResponsedata',
        'licensing.v4.config.ListClusterViolationsApiResponse' : 'ListClusterViolationsApiResponse',
        'licensing.v4.config.ScopeEnum' : 'ScopeEnum',
        'OneOflicensing.v4.config.GetSettingApiResponsedata' : 'GetSettingApiResponsedata',
        ...
        'OneOflicensing.v4.config.ListClusterAllowancesApiResponsedata' : 'ListClusterAllowancesApiResponsedata',
        'licensing.v4.config.ServiceViolationEnum' : 'ServiceViolationEnum',
        ...
        'licensing.v4.config.ListClusterEntitlementsApiResponse' : 'ListClusterEntitlementsApiResponse',
        'licensing.v4.agreements.GetEulaApiResponse' : 'GetEulaApiResponse',
        'licensing.v4.config.ServiceViolation' : 'ServiceViolation',
        'licensing.v4.config.GetClusterViolationApiResponse' : 'GetClusterViolationApiResponse',
        'licensing.v4.config.EnforcementActionsEnum' : 'EnforcementActionsEnum',
        'licensing.v4.config.LicenseProjection' : 'LicenseProjection',
        'licensing.v4.config.EnforcementLevelEnum' : 'EnforcementLevelEnum',
        'licensing.v4.config.ListClusterAllowancesApiResponse' : 'ListClusterAllowancesApiResponse',
        'licensing.v4.config.TypeEnum' : 'TypeEnum',
        ...
        'licensing.v4.config.ClusterViolation' : 'ClusterViolation',
        'licensing.v4.config.LicenseCategoryEnum' : 'LicenseCategoryEnum',
        ...
        'licensing.v4.config.PostPaidCategoryEnum' : 'PostPaidCategoryEnum',
        'licensing.v4.config.GetComplianceApiResponse' : 'GetComplianceApiResponse',
        'licensing.v4.config.LicenseTypeEnum' : 'LicenseTypeEnum',
        'OneOflicensing.v4.config.ListClusterViolationsApiResponsedata' : 'ListClusterViolationsApiResponsedata',
        'licensing.v4.config.Compliance' : 'Compliance',
        'licensing.v4.config.ClusterAllowanceProjection' : 'ClusterAllowanceProjection',
        ...
        'OneOflicensing.v4.agreements.UpdateEulaApiResponsedata' : 'UpdateEulaApiResponsedata',
