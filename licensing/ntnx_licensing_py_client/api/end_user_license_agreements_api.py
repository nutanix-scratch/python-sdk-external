...
class EndUserLicenseAgreementsApi(object):
    """IGNORE:
    ...
    def add_user(self, body, **kwargs):  # noqa: E501
        ...
        :type body:
            ...
            :class:`~ntnx_licensing_py_client.models.licensing.v4.agreements.EulaUser`, required
        ...
        try:
            if kwargs.get('async_req'):
                return self.api_client._call_api(
                    '/api/licensing/v4.0.a1/agreements/eula/$actions/add-user', 'POST',
                    path_params,
                    query_params,
                    header_params,
                    body=body_params,
    ...
    def get_eula(self, **kwargs):  # noqa: E501
        ...
        try:
            if kwargs.get('async_req'):
                return self.api_client._call_api(
                    '/api/licensing/v4.0.a1/agreements/eula', 'GET',
                    path_params,
                    query_params,
                    header_params,
                    body=body_params,
    ...
    def update_eula(self, body, **kwargs):  # noqa: E501
        """Update End User License Agreement

        >>> response = api.update_eula(body)

        This method makes a synchronous HTTP request by default. To make an asynchronous HTTP request, please pass async_req=True.

        >>> thread = api.update_eula(body, async_req=True)
        >>> result = thread.get()

        :param body: 
        :type body:

            :class:`~ntnx_licensing_py_client.models.licensing.v4.agreements.Eula`, required
        :param kwargs: kwargs for the method.
                       The following can be passed for an asynchronous HTTP call::

                           async_req=True
        :return: An instance of class :class:`~ntnx_licensing_py_client.models.licensing.v4.agreements.UpdateEulaApiResponse`.
        ...
        # verify the required parameter 'body' is set
        if ('body' not in params or params['body'] is None):
            raise ValueError("Missing the required parameter `body` when calling `update_eula`")  # noqa: E501
        ...
        try:
            if kwargs.get('async_req'):
                return self.api_client._call_api(
                    '/api/licensing/v4.0.a1/agreements/eula', 'PUT',
                    path_params,
                    query_params,
                    header_params,
                    body=body_params,
                    post_params=form_params,
                    files=local_var_files,
                    response_type='licensing.v4.agreements.UpdateEulaApiResponse',  # noqa: E501
                    auth_settings=auth_settings,
                    async_req=params.get('async_req'),
                    _return_http_data_only=params.get('_return_http_data_only'),
                    _preload_content=params.get('_preload_content', True),
