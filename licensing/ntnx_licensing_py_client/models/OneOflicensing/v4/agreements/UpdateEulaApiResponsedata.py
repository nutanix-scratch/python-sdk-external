...
class UpdateEulaApiResponsedata(object):
    ...
    def _initialize_object_type(self):
        return 'OneOflicensing.v4.agreements.UpdateEulaApiResponsedata'
    ...
    def get_discriminator_from_object(value):
        ...
        if disc in UpdateEulaApiResponsedata.discriminator_value_class_map.values():
            return list(UpdateEulaApiResponsedata.discriminator_value_class_map.keys())[list(UpdateEulaApiResponsedata.discriminator_value_class_map.values()).index(disc)]
        return None
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(UpdateEulaApiResponsedata, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, UpdateEulaApiResponsedata):
            return False
