...
class GetClusterAllowanceApiResponsedata(object):
    ...
    discriminator_value_class_map = {
        ...
        'licensing.v4.config.ClusterAllowance': 'licensing.v4.config.ClusterAllowance',
    ...
    def _initialize_object_type(self):
        return 'OneOflicensing.v4.config.GetClusterAllowanceApiResponsedata'
    ...
    def get_discriminator_from_object(value):
        ...
        if disc in GetClusterAllowanceApiResponsedata.discriminator_value_class_map.values():
            return list(GetClusterAllowanceApiResponsedata.discriminator_value_class_map.keys())[list(GetClusterAllowanceApiResponsedata.discriminator_value_class_map.values()).index(disc)]
        return None
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(GetClusterAllowanceApiResponsedata, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, GetClusterAllowanceApiResponsedata):
            return False
