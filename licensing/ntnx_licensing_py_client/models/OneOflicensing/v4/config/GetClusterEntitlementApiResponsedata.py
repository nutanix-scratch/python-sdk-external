...
class GetClusterEntitlementApiResponsedata(object):
    ...
    discriminator_value_class_map = {
        ...
        'licensing.v4.config.ClusterEntitlement': 'licensing.v4.config.ClusterEntitlement',
    ...
    def _initialize_object_type(self):
        return 'OneOflicensing.v4.config.GetClusterEntitlementApiResponsedata'
    ...
    def get_discriminator_from_object(value):
        ...
        if disc in GetClusterEntitlementApiResponsedata.discriminator_value_class_map.values():
            return list(GetClusterEntitlementApiResponsedata.discriminator_value_class_map.keys())[list(GetClusterEntitlementApiResponsedata.discriminator_value_class_map.values()).index(disc)]
        return None
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(GetClusterEntitlementApiResponsedata, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, GetClusterEntitlementApiResponsedata):
            return False
