...
class ListClusterAllowancesApiResponsedata(object):
    ...
    discriminator_value_class_map = {
        ...
        'List<licensing.v4.config.ClusterAllowance>': 'list[licensing.v4.config.ClusterAllowance]',
        'licensing.v4.error.ErrorResponse': 'licensing.v4.error.ErrorResponse',
        'List<licensing.v4.config.ClusterAllowanceProjection>': 'list[licensing.v4.config.ClusterAllowanceProjection]'
    }
    ...
    def _initialize_object_type(self):
        return 'OneOflicensing.v4.config.ListClusterAllowancesApiResponsedata'
    ...
    def get_discriminator_from_object(value):
        ...
        if disc in ListClusterAllowancesApiResponsedata.discriminator_value_class_map.values():
            return list(ListClusterAllowancesApiResponsedata.discriminator_value_class_map.keys())[list(ListClusterAllowancesApiResponsedata.discriminator_value_class_map.values()).index(disc)]
        return None
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(ListClusterAllowancesApiResponsedata, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ListClusterAllowancesApiResponsedata):
            return False
