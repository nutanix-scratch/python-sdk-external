...
class GetLicenseApiResponsedata(object):
    ...
    discriminator_value_class_map = {
        ...
        'licensing.v4.config.License': 'licensing.v4.config.License',
    ...
    def _initialize_object_type(self):
        return 'OneOflicensing.v4.config.GetLicenseApiResponsedata'
    ...
    def get_discriminator_from_object(value):
        ...
        if disc in GetLicenseApiResponsedata.discriminator_value_class_map.values():
            return list(GetLicenseApiResponsedata.discriminator_value_class_map.keys())[list(GetLicenseApiResponsedata.discriminator_value_class_map.values()).index(disc)]
        return None
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(GetLicenseApiResponsedata, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, GetLicenseApiResponsedata):
            return False
