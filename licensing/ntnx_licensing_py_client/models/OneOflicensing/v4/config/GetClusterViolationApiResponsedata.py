...
class GetClusterViolationApiResponsedata(object):
    ...
    discriminator_value_class_map = {
        ...
        'licensing.v4.config.ClusterViolation': 'licensing.v4.config.ClusterViolation',
    ...
    def _initialize_object_type(self):
        return 'OneOflicensing.v4.config.GetClusterViolationApiResponsedata'
    ...
    def get_discriminator_from_object(value):
        ...
        if disc in GetClusterViolationApiResponsedata.discriminator_value_class_map.values():
            return list(GetClusterViolationApiResponsedata.discriminator_value_class_map.keys())[list(GetClusterViolationApiResponsedata.discriminator_value_class_map.values()).index(disc)]
        return None
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(GetClusterViolationApiResponsedata, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, GetClusterViolationApiResponsedata):
            return False
