...
class ListClusterViolationsApiResponsedata(object):
    ...
    discriminator_value_class_map = {
        ...
        'List<licensing.v4.config.ClusterViolation>': 'list[licensing.v4.config.ClusterViolation]',
    ...
    def _initialize_object_type(self):
        return 'OneOflicensing.v4.config.ListClusterViolationsApiResponsedata'
    ...
    def get_discriminator_from_object(value):
        ...
        if disc in ListClusterViolationsApiResponsedata.discriminator_value_class_map.values():
            return list(ListClusterViolationsApiResponsedata.discriminator_value_class_map.keys())[list(ListClusterViolationsApiResponsedata.discriminator_value_class_map.values()).index(disc)]
        return None
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(ListClusterViolationsApiResponsedata, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ListClusterViolationsApiResponsedata):
            return False
