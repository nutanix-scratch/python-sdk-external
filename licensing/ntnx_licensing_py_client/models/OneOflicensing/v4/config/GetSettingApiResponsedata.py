...
class GetSettingApiResponsedata(object):
    ...
    discriminator_value_class_map = {
        ...
        'licensing.v4.config.Setting': 'licensing.v4.config.Setting',
    ...
    def _initialize_object_type(self):
        return 'OneOflicensing.v4.config.GetSettingApiResponsedata'
    ...
    def get_discriminator_from_object(value):
        ...
        if disc in GetSettingApiResponsedata.discriminator_value_class_map.values():
            return list(GetSettingApiResponsedata.discriminator_value_class_map.keys())[list(GetSettingApiResponsedata.discriminator_value_class_map.values()).index(disc)]
        return None
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(GetSettingApiResponsedata, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, GetSettingApiResponsedata):
            return False
