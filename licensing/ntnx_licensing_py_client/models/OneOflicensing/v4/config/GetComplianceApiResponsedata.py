...
class GetComplianceApiResponsedata(object):
    ...
    discriminator_value_class_map = {
        ...
        'licensing.v4.config.Compliance': 'licensing.v4.config.Compliance',
    ...
    def _initialize_object_type(self):
        return 'OneOflicensing.v4.config.GetComplianceApiResponsedata'
    ...
    def get_discriminator_from_object(value):
        ...
        if disc in GetComplianceApiResponsedata.discriminator_value_class_map.values():
            return list(GetComplianceApiResponsedata.discriminator_value_class_map.keys())[list(GetComplianceApiResponsedata.discriminator_value_class_map.values()).index(disc)]
        return None
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(GetComplianceApiResponsedata, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, GetComplianceApiResponsedata):
            return False
