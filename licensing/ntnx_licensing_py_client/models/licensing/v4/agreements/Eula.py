...
from ntnx_licensing_py_client.models.licensing.v4.agreements.EulaUser import EulaUser  # noqa: F401,E501
...
class Eula(ExternalizableAbstractModel):
    ...
    :type is_enabled: 
    :param accepted_by: (:attr:`accepted_by`) List of user details accepting the EULA.
    :type accepted_by: 
    ...
    swagger_types = {
        ...
        'version': 'str',
        'is_enabled': 'bool',
        'accepted_by': 'list[licensing.v4.agreements.EulaUser]',
        'ext_id': 'str',
    ...
    def __init__(self, content=None, updated_time=None, version=None, is_enabled=None, accepted_by=None, ext_id=None, links=None, tenant_id=None, *args, **kwargs):  # noqa: E501
    ...
    def accepted_by(self):
        ...
        :type:
             list[ :class:`~ntnx_licensing_py_client.models.licensing.v4.agreements.EulaUser` ]
        """  # noqa: E501
