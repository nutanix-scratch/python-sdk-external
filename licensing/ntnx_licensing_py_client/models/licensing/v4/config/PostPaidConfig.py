...
class PostPaidConfig(object):
    ...
    :param id: (:attr:`id`) Attribute for post paid configuration identifier
    :type id: 
    :param category: (:attr:`category`) Captures postpaid cluster category like msp
    :type category: 
    ...
    def __init__(self, id=None, category=None, is_pulse_required=None, *args, **kwargs):  # noqa: E501
        self.__id = None
