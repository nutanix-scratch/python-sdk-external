...
class LicenseCategoryEnum(object):
    ...
    def _initialize_object_type(self):
        return 'licensing.v4.config.LicenseCategoryEnum'
        ...
        for attr in vars(self):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(LicenseCategoryEnum, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, LicenseCategoryEnum):
            return False
