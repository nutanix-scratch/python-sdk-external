...
from ntnx_licensing_py_client.models.licensing.v4.config.EnforcementPolicyEnum import EnforcementPolicyEnum  # noqa: F401,E501
from ntnx_licensing_py_client.models.licensing.v4.config.LogicalVersion import LogicalVersion  # noqa: F401,E501
from ntnx_licensing_py_client.models.licensing.v4.config.NutanixClusterConfig import NutanixClusterConfig  # noqa: F401,E501
...
class Setting(BaseClusterInfo):
    ...
    :type is_standby: 
    :param has_non_compliant_features: (:attr:`has_non_compliant_features`) True value indicates that user is allowed to use non compliant features
    :type has_non_compliant_features: 
    :param is_license_check_disabled: (:attr:`is_license_check_disabled`) Used to enable and disable NCC license checks
    :type is_license_check_disabled: 
    :param license_class: (:attr:`license_class`) Attribute for capturing license class value
    :type license_class: 
    ...
    :type license_key: 
    :param is_ultimate_trial_ended: (:attr:`is_ultimate_trial_ended`) Indicates whether ultimate trial is active or not
    :type is_ultimate_trial_ended: 
    :param post_paid_config: (:attr:`post_paid_config`) 
    :type post_paid_config: 
    :param nutanix_cluster_config: (:attr:`nutanix_cluster_config`) 
    :type nutanix_cluster_config: 
    ...
    swagger_types = {
        ...
        'license_class': 'str',
        'enforcement_policy': 'licensing.v4.config.EnforcementPolicyEnum',
        'license_key': 'str',
        'is_ultimate_trial_ended': 'bool',
        'post_paid_config': 'licensing.v4.config.PostPaidConfig',
        'nutanix_cluster_config': 'licensing.v4.config.NutanixClusterConfig',
    ...
    attribute_map = {
        ...
        'is_ultimate_trial_ended': 'isUltimateTrialEnded',
        'post_paid_config': 'postPaidConfig',
        'nutanix_cluster_config': 'nutanixClusterConfig',
    ...
    def __init__(self, logical_version=None, is_standby=None, has_non_compliant_features=None, is_license_check_disabled=None, license_class=None, enforcement_policy=None, license_key=None, is_ultimate_trial_ended=None, post_paid_config=None, nutanix_cluster_config=None, is_multicluster=None, ext_id=None, links=None, tenant_id=None, *args, **kwargs):  # noqa: E501
        ...
        self.__is_ultimate_trial_ended = None
        self.__post_paid_config = None
        self.__nutanix_cluster_config = None
        ...
        if is_ultimate_trial_ended is not None:
            self.__is_ultimate_trial_ended = is_ultimate_trial_ended
        if post_paid_config is not None:
            self.__post_paid_config = post_paid_config
        if nutanix_cluster_config is not None:
            self.__nutanix_cluster_config = nutanix_cluster_config
    ...
    def license_class(self, license_class):
        if license_class is not None and len(license_class) > 50:
            raise ValueError("Invalid value for `license_class`, length must be less than or equal to `50`")  # noqa: E501
    ...
    def enforcement_policy(self):
        ...
        :type:
            :class:`~ntnx_licensing_py_client.models.licensing.v4.config.EnforcementPolicyEnum`
        """  # noqa: E501
    ...
    @property
    def is_ultimate_trial_ended(self):
        """
        ...
        :type:
                ...
                :class:`~bool`
        """  # noqa: E501
        return self.__is_ultimate_trial_ended

    @is_ultimate_trial_ended.setter
    def is_ultimate_trial_ended(self, is_ultimate_trial_ended):
    ...
    @property
    def nutanix_cluster_config(self):
        """
        

        :type:
            :class:`~ntnx_licensing_py_client.models.licensing.v4.config.NutanixClusterConfig`
        """  # noqa: E501
        return self.__nutanix_cluster_config

    @nutanix_cluster_config.setter
    def nutanix_cluster_config(self, nutanix_cluster_config):
