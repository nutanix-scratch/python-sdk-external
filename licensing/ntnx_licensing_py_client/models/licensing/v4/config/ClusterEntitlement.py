...
class ClusterEntitlement(BaseClusterInfo):

    """Model containing cluster details along with associated entitlements

    :param cluster_ext_id: (:attr:`cluster_ext_id`) Indicates cluster UUID.
    :type cluster_ext_id: 
    ...
    :type type: 
    :param entitlement_details: (:attr:`entitlement_details`) Attribute for capturing collection of entitlement details.
    :type entitlement_details: 
    ...
    def __init__(self, cluster_ext_id=None, is_registered=None, name=None, type=None, entitlement_details=None, is_multicluster=None, ext_id=None, links=None, tenant_id=None, *args, **kwargs):  # noqa: E501
        ...
        self.__name = None
        self.__type = None
        self.__entitlement_details = None
        ...
        if entitlement_details is not None:
            self.__entitlement_details = entitlement_details

    def _initialize_object_type(self):
        return 'licensing.v4.config.ClusterEntitlement'
    ...
    def entitlement_details(self):
        ...
        """  # noqa: E501
        return self.__entitlement_details
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(ClusterEntitlement, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ClusterEntitlement):
            return False
