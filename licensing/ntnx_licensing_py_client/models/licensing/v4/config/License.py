...
class License(BaseLicenseInfo):
    ...
    def __init__(self, meter=None, scope=None, quantity=None, consumption_details=None, name=None, type=None, category=None, sub_category=None, expiry_date=None, ext_id=None, links=None, tenant_id=None, *args, **kwargs):  # noqa: E501
    ...
    def quantity(self, quantity):
        if quantity is not None and not re.search('^(0|[1-9]\\d*)(\\.\\d+)?$', quantity):  # noqa: E501
            raise ValueError(r"Invalid value for `quantity`, must be a follow pattern or equal to `/^(0|[1-9]\\d*)(\\.\\d+)?$/`")  # noqa: E501
