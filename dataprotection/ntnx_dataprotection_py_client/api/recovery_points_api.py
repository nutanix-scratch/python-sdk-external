...
class RecoveryPointsApi(object):
    ...
    def list_recovery_points(self, _page=None, _limit=None, _filter=None, _orderby=None, _select=None, **kwargs):  # noqa: E501
        ...
        :type _limit:
            ...
            :class:`int`
        :param _filter: A URL query parameter that allows clients to filter a collection of resources. The expression specified with $filter is evaluated for each resource in the collection, and only items where the expression evaluates to true are included in the response. Expression specified with the $filter must conform to the [OData V4.01](https://docs.oasis-open.org/odata/odata/v4.01/odata-v4.01-part1-protocol.html) URL conventions. For example, filter '$filter=name eq 'karbon-ntnx-1.0' would filter the result on cluster name 'karbon-ntnx1.0', filter '$filter=startswith(name, 'C')' would filter on cluster name starting with 'C'. The filter can be applied to the following fields: - creationTime - extId - name - ownerExtId - recoveryPointType - vmRecoveryPoints/vmCategories - vmRecoveryPoints/vmExtId - vmRecoveryPoints/vmRecoveryPointExtId - vmRecoveryPoints/vmRecoveryPointId - volumeGroupRecoveryPoints/volumeGroupCategories - volumeGroupRecoveryPoints/volumeGroupExtId - volumeGroupRecoveryPoints/volumeGroupRecoveryPointExtId - volumeGroupRecoveryPoints/volumeGroupRecoveryPointId 
        :type _filter:
    ...
    def vm_recovery_point_compute_changed_regions(self, recoveryPointExtId, vmRecoveryPointExtId, extId, body, **kwargs):  # noqa: E501
        """Compute changed regions between two disk recovery points
        ...
        :type recoveryPointExtId:
            ...
            :class:`str`, required
        :param vmRecoveryPointExtId: The external identifier that can be used to retrieve the VM recovery point using its URL (Note: This attribute will be removed in future releases, use VM recovery point external identifier instead).
        ...
        :type extId:
            ...
            :class:`str`, required
        :param body: Compute changed region parameters. In these parameters, you can specify a start offset, an end offset, and a reference disk recovery point. All parameters are optional. However, if a reference disk recovery point needs to be set, all three parameters - recovery point Id, VM recovery point Id, and disk recovery point Id must be specified.
        :type body:

            :class:`~ntnx_dataprotection_py_client.models.dataprotection.v4.config.VmRecoveryPointComputeChangedRegionsRequest`, required
        :param kwargs: kwargs for the method.
                       The following can be passed for an asynchronous HTTP call::

                           async_req=True
        :return: An instance of class :class:`~ntnx_dataprotection_py_client.models.dataprotection.v4.config.ComputeChangedRegionsResponseModel`.
        ...
        try:
            if kwargs.get('async_req'):
                return self.api_client._call_api(
                    '/api/dataprotection/v4.0.b1/config/recovery-points/{recoveryPointExtId}/vm-recovery-points/{vmRecoveryPointExtId}/disk-recovery-points/{extId}/$actions/compute-changed-regions', 'POST',
                    path_params,
                    query_params,
                    header_params,
                    body=body_params,
                    post_params=form_params,
                    files=local_var_files,
                    response_type='dataprotection.v4.config.ComputeChangedRegionsResponseModel',  # noqa: E501
                    auth_settings=auth_settings,
                    async_req=params.get('async_req'),
                    _return_http_data_only=params.get('_return_http_data_only'),
                    _preload_content=params.get('_preload_content', True),
    ...
    def volume_group_recovery_point_compute_changed_regions(self, recoveryPointExtId, volumeGroupRecoveryPointExtId, extId, body, **kwargs):  # noqa: E501
        """Compute changed regions between two disk recovery points under the Volume Groups
        ...
        :type recoveryPointExtId:
            ...
            :class:`str`, required
        :param volumeGroupRecoveryPointExtId: The external identifier that can be used to retrieve the volume group recovery point using its URL (Note: This attribute will be removed in future releases, use volume group recovery point external identifier instead).
        ...
        :type body:
            ...
            :class:`~ntnx_dataprotection_py_client.models.dataprotection.v4.config.VolumeGroupRecoveryPointComputeChangedRegionsRequest`, required
        :param kwargs: kwargs for the method.
                       The following can be passed for an asynchronous HTTP call::
        ...
        try:
            if kwargs.get('async_req'):
                return self.api_client._call_api(
                    '/api/dataprotection/v4.0.b1/config/recovery-points/{recoveryPointExtId}/volume-group-recovery-points/{volumeGroupRecoveryPointExtId}/disk-recovery-points/{extId}/$actions/compute-changed-regions', 'POST',
                    path_params,
                    query_params,
                    header_params,
                    body=body_params,
