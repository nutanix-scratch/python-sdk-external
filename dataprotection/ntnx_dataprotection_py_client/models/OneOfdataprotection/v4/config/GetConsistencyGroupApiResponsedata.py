...
class GetConsistencyGroupApiResponsedata(object):
    ...
    def _initialize_object_type(self):
        return 'OneOfdataprotection.v4.config.GetConsistencyGroupApiResponsedata'
    ...
    def get_discriminator_from_object(value):
        ...
        if disc in GetConsistencyGroupApiResponsedata.discriminator_value_class_map.values():
            return list(GetConsistencyGroupApiResponsedata.discriminator_value_class_map.keys())[list(GetConsistencyGroupApiResponsedata.discriminator_value_class_map.values()).index(disc)]
        return None
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(GetConsistencyGroupApiResponsedata, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, GetConsistencyGroupApiResponsedata):
            return False
