...
class ListConsistencyGroupsApiResponsedata(object):
    ...
    def _initialize_object_type(self):
        return 'OneOfdataprotection.v4.config.ListConsistencyGroupsApiResponsedata'
    ...
    def get_discriminator_from_object(value):
        ...
        if disc in ListConsistencyGroupsApiResponsedata.discriminator_value_class_map.values():
            return list(ListConsistencyGroupsApiResponsedata.discriminator_value_class_map.keys())[list(ListConsistencyGroupsApiResponsedata.discriminator_value_class_map.values()).index(disc)]
        return None
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(ListConsistencyGroupsApiResponsedata, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ListConsistencyGroupsApiResponsedata):
            return False
