...
from ntnx_dataprotection_py_client.models.OneOfdataprotection.v4.config.ListConsistencyGroupsApiResponsedata import ListConsistencyGroupsApiResponsedata  # noqa: F401,E501
...
class ListConsistencyGroupsApiResponse(object):

    """REST response for all response codes in API path /dataprotection/v4.0.b1/config/consistency-groups Get operation
    ...
    swagger_types = {
        ...
        'data': 'OneOfdataprotection.v4.config.ListConsistencyGroupsApiResponsedata',
    ...
    def _initialize_object_type(self):
        return 'dataprotection.v4.config.ListConsistencyGroupsApiResponse'
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(ListConsistencyGroupsApiResponse, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ListConsistencyGroupsApiResponse):
            return False
