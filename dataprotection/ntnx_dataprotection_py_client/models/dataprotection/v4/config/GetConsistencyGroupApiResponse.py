...
from ntnx_dataprotection_py_client.models.OneOfdataprotection.v4.config.GetConsistencyGroupApiResponsedata import GetConsistencyGroupApiResponsedata  # noqa: F401,E501
...
class GetConsistencyGroupApiResponse(object):

    """REST response for all response codes in API path /dataprotection/v4.0.b1/config/consistency-groups/{extId} Get operation
    ...
    swagger_types = {
        ...
        'data': 'OneOfdataprotection.v4.config.GetConsistencyGroupApiResponsedata',
    ...
    def _initialize_object_type(self):
        return 'dataprotection.v4.config.GetConsistencyGroupApiResponse'
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(GetConsistencyGroupApiResponse, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, GetConsistencyGroupApiResponse):
            return False
