...
class ApiClient(object):
    ...
    # Populated if multiple schemas exist with the same name
        ...
        'dataprotection.v4.config.ListConsistencyGroupsApiResponse' : 'ListConsistencyGroupsApiResponse',
        ...
        'dataprotection.v4.config.GetConsistencyGroupApiResponse' : 'GetConsistencyGroupApiResponse',
        ...
        'OneOfdataprotection.v4.config.GetConsistencyGroupApiResponsedata' : 'GetConsistencyGroupApiResponsedata',
        ...
        'OneOfdataprotection.v4.config.ListConsistencyGroupsApiResponsedata' : 'ListConsistencyGroupsApiResponsedata',
    ...
    def __deserialize_response(self, response, response_type):
        ...
        :type response: :class:`~ntnx_dataprotection_py_client.rest.RESTResponse`, required
    ...
    def _call_api(self, resource_path, method,
        ...
        :param _request_timeout: Timeout setting for this request. It needs to be a pair (list) of
            ...
            the timeouts will be derived from the :class:`~ntnx_dataprotection_py_client.configuration.Configuration`.
    ...
    def __deserialize_date(self, string):
        ...
        :param string:
        :type string: str
        :raises :class:`~ntnx_dataprotection_py_client.rest.ApiException` if provided string is not a valid date
        :return: date object
        """
        try:
    ...
    def __deserialize_datatime(self, string):
        ...
        :raises :class:`~ntnx_dataprotection_py_client.rest.ApiException` if provided string is not a valid datetime
    ...
    def __getattr(self, name):
        if name in self.DUPLICATE_SCHEMA_MAPPING:
            return getattr(ntnx_dataprotection_py_client.models, self.DUPLICATE_SCHEMA_MAPPING[name])
        if hasattr(ntnx_dataprotection_py_client.models, name.split('.')[-1]):
            return getattr(ntnx_dataprotection_py_client.models, name.split('.')[-1])
        else:
            return getattr(ntnx_dataprotection_py_client.models, name)
