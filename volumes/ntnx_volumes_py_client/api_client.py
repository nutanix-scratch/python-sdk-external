...
import ntnx_volumes_py_client.models
from ntnx_volumes_py_client import rest
...
class ApiClient(object):
    ...
    # Populated if multiple schemas exist with the same name
        'volumes.v4.config.TargetParam' : 'TargetParam',
        'OneOfvolumes.v4.config.UpdateVolumeGroupMetadataInfoApiResponsedata' : 'UpdateVolumeGroupMetadataInfoApiResponsedata',
        'volumes.v4.config.ListIscsiClientsApiResponse' : 'ListIscsiClientsApiResponse',
        ...
        'OneOfvolumes.v4.config.CreateVolumeDiskApiResponsedata' : 'CreateVolumeDiskApiResponsedata',
        'common.v1.config.IPv6Address' : 'IPv6Address',
        'volumes.v4.stats.TimeValuePair' : 'TimeValuePair',
        'volumes.v4.config.AttachVmApiResponse' : 'AttachVmApiResponse',
        'volumes.v4.config.GetVolumeDiskApiResponse' : 'GetVolumeDiskApiResponse',
        'OneOfvolumes.v4.error.ErrorResponseerror' : 'ErrorResponseerror',
        'common.v1.config.Flag' : 'Flag',
        'volumes.v4.config.ListCategoryAssociationsApiResponse' : 'ListCategoryAssociationsApiResponse',
        'volumes.v4.config.DiskStorageFeatures' : 'DiskStorageFeatures',
        'volumes.v4.config.ListExternalIscsiAttachmentsApiResponse' : 'ListExternalIscsiAttachmentsApiResponse',
        'volumes.v4.config.IscsiFeatures' : 'IscsiFeatures',
        'volumes.v4.config.VolumeGroupAttachmentSite' : 'VolumeGroupAttachmentSite',
        'OneOfvolumes.v4.config.ListVolumeGroupsApiResponsedata' : 'ListVolumeGroupsApiResponsedata',
        'volumes.v4.config.DeleteVolumeDiskApiResponse' : 'DeleteVolumeDiskApiResponse',
        'volumes.v4.config.IscsiClientAttachmentProjection' : 'IscsiClientAttachmentProjection',
        'volumes.v4.config.UpdateIscsiClientApiResponse' : 'UpdateIscsiClientApiResponse',
        'volumes.v4.stats.GetVolumeGroupStatsApiResponse' : 'GetVolumeGroupStatsApiResponse',
        'OneOfvolumes.v4.config.ListVmAttachmentsApiResponsedata' : 'ListVmAttachmentsApiResponsedata',
        'prism.v4.config.TaskReference' : 'TaskReference',
        'common.v1.config.EntityReference' : 'EntityReference',
        'OneOfvolumes.v4.config.DeleteVolumeGroupApiResponsedata' : 'DeleteVolumeGroupApiResponsedata',
        'OneOfvolumes.v4.config.UpdateVolumeDiskApiResponsedata' : 'UpdateVolumeDiskApiResponsedata',
        'volumes.v4.config.CategoryEntityReferences' : 'CategoryEntityReferences',
        'volumes.v4.stats.VolumeGroupStatsProjection' : 'VolumeGroupStatsProjection',
        'OneOfvolumes.v4.config.GetVolumeDiskApiResponsedata' : 'GetVolumeDiskApiResponsedata',
        'OneOfvolumes.v4.config.ListExternalIscsiAttachmentsApiResponsedata' : 'ListExternalIscsiAttachmentsApiResponsedata',
        'volumes.v4.config.UpdateVolumeGroupMetadataApiResponse' : 'UpdateVolumeGroupMetadataApiResponse',
        'volumes.v4.config.GetIscsiClientApiResponse' : 'GetIscsiClientApiResponse',
        'volumes.v4.config.VolumeGroupMetadata' : 'VolumeGroupMetadata',
        'OneOfvolumes.v4.config.ListVolumeDisksApiResponsedata' : 'ListVolumeDisksApiResponsedata',
        'volumes.v4.stats.VolumeDiskStats' : 'VolumeDiskStats',
        'OneOfvolumes.v4.config.DisassociateCategoryApiResponsedata' : 'DisassociateCategoryApiResponsedata',
        'volumes.v4.config.ListVolumeDisksApiResponse' : 'ListVolumeDisksApiResponse',
        'volumes.v4.config.RevertSpec' : 'RevertSpec',
        'OneOfvolumes.v4.config.ListCategoryAssociationsApiResponsedata' : 'ListCategoryAssociationsApiResponsedata',
        'OneOfvolumes.v4.config.ListIscsiClientsApiResponsedata' : 'ListIscsiClientsApiResponsedata',
        'common.v1.config.Metadata' : 'Metadata',
        'volumes.v4.config.VmAttachmentProjection' : 'VmAttachmentProjection',
        'OneOfvolumes.v4.config.UpdateIscsiClientApiResponsedata' : 'UpdateIscsiClientApiResponsedata',
        'volumes.v4.error.AppMessage' : 'AppMessage',
        'volumes.v4.error.ErrorResponse' : 'ErrorResponse',
        'volumes.v4.config.VmAttachment' : 'VmAttachment',
        'OneOfvolumes.v4.config.ResumeVolumeGroupSynchronousReplicationApiResponsedata' : 'ResumeVolumeGroupSynchronousReplicationApiResponsedata',
        'volumes.v4.config.ClusterProjection' : 'ClusterProjection',
        'volumes.v4.config.CreateVolumeDiskApiResponse' : 'CreateVolumeDiskApiResponse',
        'common.v1.config.IPAddressOrFQDN' : 'IPAddressOrFQDN',
        'volumes.v4.config.NvmfClientAttachmentProjection' : 'NvmfClientAttachmentProjection',
        'volumes.v4.config.VolumeGroupProjection' : 'VolumeGroupProjection',
        'common.v1.response.ApiResponseMetadata' : 'ApiResponseMetadata',
        'volumes.v4.config.Task' : 'Task',
        'volumes.v4.config.ListVmAttachmentsApiResponse' : 'ListVmAttachmentsApiResponse',
        'volumes.v4.config.UpdateVolumeGroupMetadataInfoApiResponse' : 'UpdateVolumeGroupMetadataInfoApiResponse',
        'volumes.v4.config.PauseVolumeGroupSynchronousReplicationApiResponse' : 'PauseVolumeGroupSynchronousReplicationApiResponse',
        'volumes.v4.config.ResumeVolumeGroupSynchronousReplicationApiResponse' : 'ResumeVolumeGroupSynchronousReplicationApiResponse',
        'volumes.v4.config.VolumeDiskProjection' : 'VolumeDiskProjection',
        'OneOfvolumes.v4.config.AttachIscsiClientApiResponsedata' : 'AttachIscsiClientApiResponsedata',
        'OneOfvolumes.v4.config.GetVolumeGroupMetadataApiResponsedata' : 'GetVolumeGroupMetadataApiResponsedata',
        'volumes.v4.stats.GetVolumeDiskStatsApiResponse' : 'GetVolumeDiskStatsApiResponse',
        'volumes.v4.config.UpdateVolumeDiskApiResponse' : 'UpdateVolumeDiskApiResponse',
        'volumes.v4.config.VolumeDisk' : 'VolumeDisk',
        'OneOfvolumes.v4.config.UpdateVolumeGroupApiResponsedata' : 'UpdateVolumeGroupApiResponsedata',
        'volumes.v4.config.StorageFeatures' : 'StorageFeatures',
        'OneOfvolumes.v4.config.GetVolumeGroupApiResponsedata' : 'GetVolumeGroupApiResponsedata',
        'common.v1.config.EntityType' : 'EntityType',
        'common.v1.response.ExternalizableAbstractModel' : 'ExternalizableAbstractModel',
        'volumes.v4.config.CategoryDetails' : 'CategoryDetails',
        'OneOfvolumes.v4.config.AttachVmApiResponsedata' : 'AttachVmApiResponsedata',
        'common.v1.config.Message' : 'Message',
        'volumes.v4.config.GetVolumeGroupApiResponse' : 'GetVolumeGroupApiResponse',
        'volumes.v4.config.ListVolumeGroupsApiResponse' : 'ListVolumeGroupsApiResponse',
        'volumes.v4.config.CreateVolumeGroupApiResponse' : 'CreateVolumeGroupApiResponse',
        'volumes.v4.error.SchemaValidationError' : 'SchemaValidationError',
        'OneOfvolumes.v4.config.GetIscsiClientApiResponsedata' : 'GetIscsiClientApiResponsedata',
        'volumes.v4.config.DetachIscsiClientApiResponse' : 'DetachIscsiClientApiResponse',
        'volumes.v4.config.UsageType' : 'UsageType',
        'OneOfcommon.v1.config.KVPairvalue' : 'KVPairvalue',
        'volumes.v4.config.GetVolumeGroupMetadataApiResponse' : 'GetVolumeGroupMetadataApiResponse',
        'volumes.v4.error.SchemaValidationErrorMessage' : 'SchemaValidationErrorMessage',
        'OneOfvolumes.v4.config.PauseVolumeGroupSynchronousReplicationApiResponsedata' : 'PauseVolumeGroupSynchronousReplicationApiResponsedata',
        'OneOfvolumes.v4.stats.GetVolumeGroupStatsApiResponsedata' : 'GetVolumeGroupStatsApiResponsedata',
        'volumes.v4.config.DeleteVolumeGroupApiResponse' : 'DeleteVolumeGroupApiResponse',
        'volumes.v4.config.MigrateVolumeGroupApiResponse' : 'MigrateVolumeGroupApiResponse',
        'OneOfvolumes.v4.config.RevertVolumeGroupApiResponsedata' : 'RevertVolumeGroupApiResponsedata',
        'volumes.v4.config.VolumeGroup' : 'VolumeGroup',
        'common.v1.config.MessageSeverity' : 'MessageSeverity',
        'volumes.v4.config.SharingStatus' : 'SharingStatus',
        'OneOfvolumes.v4.config.DetachVmApiResponsedata' : 'DetachVmApiResponsedata',
        'volumes.v4.config.DisassociateCategoryApiResponse' : 'DisassociateCategoryApiResponse',
        'volumes.v4.config.AttachIscsiClientApiResponse' : 'AttachIscsiClientApiResponse',
        'volumes.v4.config.IscsiClientAttachment' : 'IscsiClientAttachment',
        'OneOfvolumes.v4.config.DetachIscsiClientApiResponsedata' : 'DetachIscsiClientApiResponsedata',
        'common.v1.response.ApiLink' : 'ApiLink',
        'volumes.v4.config.FlashMode' : 'FlashMode',
        'volumes.v4.config.IscsiClient' : 'IscsiClient',
        'volumes.v4.config.AuthenticationType' : 'AuthenticationType',
        'volumes.v4.config.NvmfClient' : 'NvmfClient',
        'OneOfvolumes.v4.config.UpdateVolumeGroupMetadataApiResponsedata' : 'UpdateVolumeGroupMetadataApiResponsedata',
        'OneOfvolumes.v4.stats.GetVolumeDiskStatsApiResponsedata' : 'GetVolumeDiskStatsApiResponsedata',
        'volumes.v4.config.NvmfClientProjection' : 'NvmfClientProjection',
        'volumes.v4.config.NvmfClientAttachment' : 'NvmfClientAttachment',
        'OneOfvolumes.v4.config.MigrateVolumeGroupApiResponsedata' : 'MigrateVolumeGroupApiResponsedata',
        'volumes.v4.config.RevertVolumeGroupApiResponse' : 'RevertVolumeGroupApiResponse',
        'volumes.v4.config.VolumeGroupMetadataProjection' : 'VolumeGroupMetadataProjection',
        'volumes.v4.config.Cluster' : 'Cluster',
        'volumes.v4.config.UpdateVolumeGroupApiResponse' : 'UpdateVolumeGroupApiResponse',
        'OneOfvolumes.v4.config.AssociateCategoryApiResponsedata' : 'AssociateCategoryApiResponsedata',
        'OneOfvolumes.v4.config.DeleteVolumeDiskApiResponsedata' : 'DeleteVolumeDiskApiResponsedata',
        'common.v1.config.TenantAwareModel' : 'TenantAwareModel',
        'OneOfvolumes.v4.config.CreateVolumeGroupApiResponsedata' : 'CreateVolumeGroupApiResponsedata',
        'volumes.v4.config.DetachVmApiResponse' : 'DetachVmApiResponse',
        'volumes.v4.stats.VolumeGroupStats' : 'VolumeGroupStats',
        'volumes.v4.config.AssociateCategoryApiResponse' : 'AssociateCategoryApiResponse',
        'volumes.v4.config.IscsiClientProjection' : 'IscsiClientProjection',
    ...
    def __call_api(
        ...
        if response_data.status == 401:
            ...
            if response_data.status == 401:
                raise ntnx_volumes_py_client.rest.ApiException(http_resp=response_data)
    ...
    def __deserialize_response(self, response, response_type):
        ...
        :type response: :class:`~ntnx_volumes_py_client.rest.RESTResponse`, required
    ...
    def _call_api(self, resource_path, method,
        ...
        :param _request_timeout: Timeout setting for this request. It needs to be a pair (list) of
            ...
            the timeouts will be derived from the :class:`~ntnx_volumes_py_client.configuration.Configuration`.
    ...
    def __deserialize_file(self, response):
        ...
        :param response: :class:`~ntnx_volumes_py_client.rest.RESTResponse`
        :return: File path
        """
    ...
    def __deserialize_date(self, string):
        ...
        :param string:
        :type string: str
        :raises :class:`~ntnx_volumes_py_client.rest.ApiException` if provided string is not a valid date
        :return: date object
        """
        try:
    ...
    def __deserialize_datatime(self, string):
        ...
        :raises :class:`~ntnx_volumes_py_client.rest.ApiException` if provided string is not a valid datetime
    ...
    def __getattr(self, name):
        if name in self.DUPLICATE_SCHEMA_MAPPING:
            return getattr(ntnx_volumes_py_client.models, self.DUPLICATE_SCHEMA_MAPPING[name])
        if hasattr(ntnx_volumes_py_client.models, name.split('.')[-1]):
            return getattr(ntnx_volumes_py_client.models, name.split('.')[-1])
        else:
            return getattr(ntnx_volumes_py_client.models, name)
