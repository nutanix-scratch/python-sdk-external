...
class ListVmStatsResponsedata(object):
    ...
    discriminator_value_class_map = {
        ...
        'List<vmm.v4.esxi.stats.VmStats>': 'list[vmm.v4.esxi.stats.VmStats]',
    ...
    def _initialize_object_type(self):
        return 'OneOfvmm.v4.esxi.stats.ListVmStatsResponsedata'
    ...
    def get_discriminator_from_object(value):
        ...
        if disc in ListVmStatsResponsedata.discriminator_value_class_map.values():
            return list(ListVmStatsResponsedata.discriminator_value_class_map.keys())[list(ListVmStatsResponsedata.discriminator_value_class_map.values()).index(disc)]
        return None
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(ListVmStatsResponsedata, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ListVmStatsResponsedata):
            return False
