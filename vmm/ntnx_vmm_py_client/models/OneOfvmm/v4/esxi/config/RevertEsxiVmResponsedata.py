...
class RevertEsxiVmResponsedata(object):
    ...
    def _initialize_object_type(self):
        return 'OneOfvmm.v4.esxi.config.RevertEsxiVmResponsedata'
    ...
    def get_discriminator_from_object(value):
        ...
        if disc in RevertEsxiVmResponsedata.discriminator_value_class_map.values():
            return list(RevertEsxiVmResponsedata.discriminator_value_class_map.keys())[list(RevertEsxiVmResponsedata.discriminator_value_class_map.values()).index(disc)]
        return None
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(RevertEsxiVmResponsedata, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, RevertEsxiVmResponsedata):
            return False
