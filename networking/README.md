...
try:
    api_response = bgp_sessions_api_instance.get_bgp_session_by_id(extId)
...
try:
    ...
    api_response = bgp_sessions_api_instance.update_bgp_session_by_id(body, extId, if_match=etag_value) # Use the extracted etag value
except ApiException as e:
```
