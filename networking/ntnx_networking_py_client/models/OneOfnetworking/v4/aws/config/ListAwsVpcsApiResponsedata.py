...
class ListAwsVpcsApiResponsedata(object):
    ...
    discriminator_value_class_map = {
        ...
        'List<networking.v4.aws.config.AwsVpc>': 'list[networking.v4.aws.config.AwsVpc]',
    ...
    def _initialize_object_type(self):
        return 'OneOfnetworking.v4.aws.config.ListAwsVpcsApiResponsedata'
    ...
    def get_discriminator_from_object(value):
        ...
        if disc in ListAwsVpcsApiResponsedata.discriminator_value_class_map.values():
            return list(ListAwsVpcsApiResponsedata.discriminator_value_class_map.keys())[list(ListAwsVpcsApiResponsedata.discriminator_value_class_map.values()).index(disc)]
        return None
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(ListAwsVpcsApiResponsedata, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ListAwsVpcsApiResponsedata):
            return False
