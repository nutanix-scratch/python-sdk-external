...
class ListAwsSubnetsApiResponsedata(object):
    ...
    discriminator_value_class_map = {
        ...
        'List<networking.v4.aws.config.AwsSubnet>': 'list[networking.v4.aws.config.AwsSubnet]',
    ...
    def _initialize_object_type(self):
        return 'OneOfnetworking.v4.aws.config.ListAwsSubnetsApiResponsedata'
    ...
    def get_discriminator_from_object(value):
        ...
        if disc in ListAwsSubnetsApiResponsedata.discriminator_value_class_map.values():
            return list(ListAwsSubnetsApiResponsedata.discriminator_value_class_map.keys())[list(ListAwsSubnetsApiResponsedata.discriminator_value_class_map.values()).index(disc)]
        return None
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(ListAwsSubnetsApiResponsedata, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ListAwsSubnetsApiResponsedata):
            return False
