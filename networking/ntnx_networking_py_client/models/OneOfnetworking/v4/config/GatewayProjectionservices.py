...
class GatewayProjectionservices(object):
    ...
    def get_discriminator_from_object(value):
        ...
        if disc in GatewayProjectionservices.discriminator_value_class_map.values():
            return list(GatewayProjectionservices.discriminator_value_class_map.keys())[list(GatewayProjectionservices.discriminator_value_class_map.values()).index(disc)]
        return None
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(GatewayProjectionservices, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, GatewayProjectionservices):
            return False
