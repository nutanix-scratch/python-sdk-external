...
class RoutingPolicyMatchConditionprotocol_parameters(object):
    ...
    discriminator_value_class_map = {
        ...
        'networking.v4.config.LayerFourProtocolObject': 'networking.v4.config.LayerFourProtocolObject',
        'networking.v4.config.ICMPObject': 'networking.v4.config.ICMPObject',
        'networking.v4.config.ProtocolNumberObject': 'networking.v4.config.ProtocolNumberObject'
    }

    ONE_OF_ITEM_DISCRIMINATOR_NAME = '$protocolParametersItemDiscriminator'
    ...
    def get_discriminator_from_object(value):
        ...
        if disc in RoutingPolicyMatchConditionprotocol_parameters.discriminator_value_class_map.values():
            return list(RoutingPolicyMatchConditionprotocol_parameters.discriminator_value_class_map.keys())[list(RoutingPolicyMatchConditionprotocol_parameters.discriminator_value_class_map.values()).index(disc)]
        return None
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(RoutingPolicyMatchConditionprotocol_parameters, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, RoutingPolicyMatchConditionprotocol_parameters):
            return False
