...
class StatsQueryResponseBase(ExternalizableAbstractModel):
    ...
    :param entity_uuid: (:attr:`entity_uuid`) UUID of queried entity.
    :type entity_uuid: 
    ...
    def __init__(self, entity_uuid=None, stat_type=None, ext_id=None, links=None, tenant_id=None, *args, **kwargs):  # noqa: E501
    ...
    def stat_type(self):
        ...
        :type:
            :class:`~ntnx_networking_py_client.models.common.v1.stats.DownSamplingOperator`
        """  # noqa: E501
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(StatsQueryResponseBase, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, StatsQueryResponseBase):
            return False
