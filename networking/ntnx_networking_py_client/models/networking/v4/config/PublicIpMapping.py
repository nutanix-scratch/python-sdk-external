...
class PublicIpMapping(object):
    ...
    :param public_ip: (:attr:`public_ip`) 
    :type public_ip: required
    ...
    swagger_types = {
        ...
        'public_ip': 'common.v1.config.IPAddress',
    ...
    def __init__(self, private_ip=None, public_ip=None, *args, **kwargs):  # noqa: E501
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(PublicIpMapping, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, PublicIpMapping):
            return False
