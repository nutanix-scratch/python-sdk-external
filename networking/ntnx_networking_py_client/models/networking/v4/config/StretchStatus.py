...
class StretchStatus(object):
    ...
    :type detail: 
    :param tunnel_state: (:attr:`tunnel_state`) 
    :type tunnel_state: 
    :param interface_state: (:attr:`interface_state`) 
    :type interface_state: 
    :param round_trip_time_millis: (:attr:`round_trip_time_millis`) The round-trip time, in milliseconds, between subnets in this stretch configuration.
    :type round_trip_time_millis: 
    ...
    attribute_map = {
        ...
        'round_trip_time_millis': 'roundTripTimeMillis',
        '_reserved': '$reserved',
    ...
    def __init__(self, detail=None, tunnel_state=None, interface_state=None, round_trip_time_millis=None, *args, **kwargs):  # noqa: E501
        self.__detail = None
        self.__tunnel_state = None
        self.__interface_state = None
        self.__round_trip_time_millis = None
        ...
        if round_trip_time_millis is not None:
    ...
    @property
    def round_trip_time_millis(self):
        """
        ...
        :type:
                ...
                :class:`~float`
        """  # noqa: E501
        return self.__round_trip_time_millis

    @round_trip_time_millis.setter
    def round_trip_time_millis(self, round_trip_time_millis):
