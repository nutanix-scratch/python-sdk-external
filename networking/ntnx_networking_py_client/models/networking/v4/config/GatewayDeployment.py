...
class GatewayDeployment(object):
    ...
    def management_interface(self):
        ...
        :type:
            :class:`~ntnx_networking_py_client.models.networking.v4.config.GatewayManagementInterface`
        """  # noqa: E501
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(GatewayDeployment, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, GatewayDeployment):
            return False
