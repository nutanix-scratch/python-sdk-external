...
class AzureExternalSubnetBinding(object):
    ...
    :param router_port_mac: (:attr:`router_port_mac`) MAC address of the router port of Atlas Flow Gateway.
    :type router_port_mac: required
    :param azure_external_network_prefix: (:attr:`azure_external_network_prefix`) 
    :type azure_external_network_prefix: required
    :param peer_to_peer_network_prefix: (:attr:`peer_to_peer_network_prefix`) 
    :type peer_to_peer_network_prefix: 
    :param eni_primary_ip: (:attr:`eni_primary_ip`) 
    :type eni_primary_ip: 
    :param eni_id: (:attr:`eni_id`) External network interface Id.
    :type eni_id: 
    :param resource_group_id: (:attr:`resource_group_id`) Resource group Id.
    ...
    def __init__(self, router_port_mac=None, azure_external_network_prefix=None, peer_to_peer_network_prefix=None, eni_primary_ip=None, eni_id=None, resource_group_id=None, *args, **kwargs):  # noqa: E501
    ...
    def resource_group_id(self):
        ...
        :type:
                ...
                :class:`~str`
        """  # noqa: E501
        return self.__resource_group_id
