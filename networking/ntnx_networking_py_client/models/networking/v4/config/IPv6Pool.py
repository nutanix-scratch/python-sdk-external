...
class IPv6Pool(object):
    ...
    :param end_ip: (:attr:`end_ip`) 
    :type end_ip: required
    ...
    """  # noqa: E501
    swagger_types = {
        'start_ip': 'common.v1.config.IPv6Address',
        'end_ip': 'common.v1.config.IPv6Address',
    ...
    def __init__(self, start_ip=None, end_ip=None, *args, **kwargs):  # noqa: E501
        self.__start_ip = None
        self.__end_ip = None
    ...
    def start_ip(self, start_ip):
        if start_ip is None:
            raise ValueError("Invalid value for `start_ip`, must not be `None`")  # noqa: E501
    ...
    def end_ip(self, end_ip):
        if end_ip is None:
            raise ValueError("Invalid value for `end_ip`, must not be `None`")  # noqa: E501
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, IPv6Pool):
            return False
