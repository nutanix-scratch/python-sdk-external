...
class Layer2StretchSubnetInfo(object):
    ...
    :param subnet_reference: (:attr:`subnet_reference`) 
    :type subnet_reference: 
    :param vlan_id: (:attr:`vlan_id`) VLAN Id (if this subnet is vlan-backed).
    :type vlan_id: 
    ...
    """  # noqa: E501
    swagger_types = {
        'subnet_reference': 'common.v1.config.EntityReference',
        'vlan_id': 'int',
        'vpc_reference': 'common.v1.config.EntityReference',
        'ip_subnet': 'networking.v4.config.IPSubnet',
        'default_gateway_ip': 'common.v1.config.IPAddress',
    ...
    def __init__(self, subnet_reference=None, vlan_id=None, vpc_reference=None, ip_subnet=None, default_gateway_ip=None, cluster_reference=None, *args, **kwargs):  # noqa: E501
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(Layer2StretchSubnetInfo, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, Layer2StretchSubnetInfo):
            return False
