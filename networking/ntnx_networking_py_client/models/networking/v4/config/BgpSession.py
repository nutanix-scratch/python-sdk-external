...
class BgpSession(NetworkingBaseModel):
    ...
    :type advertised_routes: 
    :param received_routes: (:attr:`received_routes`) Received routes.
    :type received_routes: 
    :param ignored_routes: (:attr:`ignored_routes`) Received routes that are ignored either because the next hop is not L2-adjacent to the VPC or the upper limit of the received routes per session has exceeded.
    :type ignored_routes: 
