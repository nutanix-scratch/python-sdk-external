...
from ntnx_networking_py_client.models.networking.v4.config.VirtualSwitchProjection import VirtualSwitchProjection  # noqa: F401,E501
...
class SubnetProjection(Subnet):

    """

    :param virtual_switch_projection: (:attr:`virtual_switch_projection`) 
    :type virtual_switch_projection: 
    ...
    """  # noqa: E501
    swagger_types = {
        'virtual_switch_projection': 'networking.v4.config.VirtualSwitchProjection',
    ...
    attribute_map = {
        'virtual_switch_projection': 'virtualSwitchProjection',
    ...
    def __init__(self, virtual_switch_projection=None, vpc_projection=None, name=None, description=None, subnet_type=None, network_id=None, dhcp_options=None, ip_config=None, cluster_reference=None, virtual_switch_reference=None, vpc_reference=None, is_nat_enabled=None, is_external=None, reserved_ip_addresses=None, dynamic_ip_addresses=None, network_function_chain_reference=None, bridge_name=None, is_advanced_networking=None, cluster_name=None, hypervisor_type=None, virtual_switch=None, vpc=None, ip_prefix=None, ip_usage=None, migration_state=None, metadata=None, ext_id=None, links=None, tenant_id=None, *args, **kwargs):  # noqa: E501
        ...
        self.__virtual_switch_projection = None
        self.__vpc_projection = None
        self.discriminator = None
        if virtual_switch_projection is not None:
    ...
    def virtual_switch_projection(self):
        ...
        """  # noqa: E501
        return self.__virtual_switch_projection

    @virtual_switch_projection.setter
    def virtual_switch_projection(self, virtual_switch_projection):
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(SubnetProjection, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, SubnetProjection):
            return False
