...
class Cluster(object):
    ...
    :param ext_id: (:attr:`ext_id`) Reference ExtId for the cluster. This is a required parameter on Prism Element ; and is optional on Prism Central
    :type ext_id: required
    :param hosts: (:attr:`hosts`) Host configuration array
    :type hosts: required
    :param gateway_ip_address: (:attr:`gateway_ip_address`) 
    :type gateway_ip_address: 
    ...
    swagger_types = {
        'ext_id': 'str',
        'hosts': 'list[networking.v4.config.Host]',
        'gateway_ip_address': 'common.v1.config.IPv4Address',
    ...
    def __init__(self, ext_id=None, hosts=None, gateway_ip_address=None, *args, **kwargs):  # noqa: E501
        self.__ext_id = None
        self.__hosts = None
    ...
    def hosts(self):
        ...
        :type:
             list[ :class:`~ntnx_networking_py_client.models.networking.v4.config.Host` ]
        """  # noqa: E501
        return self.__hosts
