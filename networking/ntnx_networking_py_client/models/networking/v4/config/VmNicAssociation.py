...
class VmNicAssociation(object):
    ...
    :param vpc_reference: (:attr:`vpc_reference`) VPC reference to which the VM NIC subnet belongs.
    :type vpc_reference: 
    ...
    def __init__(self, vm_nic_reference=None, vpc_reference=None, *args, **kwargs):  # noqa: E501
    ...
    def vm_nic_reference(self, vm_nic_reference):
        if vm_nic_reference is None:
            raise ValueError("Invalid value for `vm_nic_reference`, must not be `None`")  # noqa: E501
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(VmNicAssociation, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, VmNicAssociation):
            return False
