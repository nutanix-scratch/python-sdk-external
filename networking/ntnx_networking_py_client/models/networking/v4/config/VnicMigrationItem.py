...
class VnicMigrationItem(object):
    ...
    def __init__(self, nic_uuid=None, network_uuid=None, requested_ip_addresses=None, *args, **kwargs):  # noqa: E501
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(VnicMigrationItem, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, VnicMigrationItem):
            return False
