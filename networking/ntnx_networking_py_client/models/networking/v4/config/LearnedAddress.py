...
class LearnedAddress(object):
    ...
    :type vm_reference: 
    :param mac_address: (:attr:`mac_address`) 
    :type mac_address: 
    :param last_seen: (:attr:`last_seen`) Last time when the learned address is observed.
    :type last_seen: 
    ...
    """  # noqa: E501
    swagger_types = {
        'vm_reference': 'common.v1.config.EntityReference',
        'mac_address': 'str',
        'last_seen': 'str',
    ...
    def __init__(self, vm_reference=None, mac_address=None, last_seen=None, *args, **kwargs):  # noqa: E501
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(LearnedAddress, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, LearnedAddress):
            return False
