...
class ClusterFlowStatus(object):
    ...
    """  # noqa: E501
    swagger_types = {
        'cluster_status_list': 'list[networking.v4.config.ClusterStatus]',
    ...
    def __init__(self, cluster_status_list=None, *args, **kwargs):  # noqa: E501
    ...
    def cluster_status_list(self):
        ...
        :type:
             list[ :class:`~ntnx_networking_py_client.models.networking.v4.config.ClusterStatus` ]
        """  # noqa: E501
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(ClusterFlowStatus, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ClusterFlowStatus):
            return False
