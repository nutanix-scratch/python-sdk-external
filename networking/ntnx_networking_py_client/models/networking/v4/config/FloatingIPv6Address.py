...
class FloatingIPv6Address(object):
    ...
    :type value: 
    :param prefix_length: (:attr:`prefix_length`) Prefix length of the network to which this host IPv6 address belongs. (**Default** 128)
    :type prefix_length: 
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(FloatingIPv6Address, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, FloatingIPv6Address):
            return False
