...
class IPv4Config(object):
    ...
    """  # noqa: E501
    swagger_types = {
        'ip_subnet': 'networking.v4.config.IPv4Subnet',
        'default_gateway_ip': 'common.v1.config.IPv4Address',
        'dhcp_server_address': 'common.v1.config.IPv4Address',
        'pool_list': 'list[networking.v4.config.IPv4Pool]',
    ...
    def pool_list(self):
        ...
        :type:
             list[ :class:`~ntnx_networking_py_client.models.networking.v4.config.IPv4Pool` ]
        """  # noqa: E501
