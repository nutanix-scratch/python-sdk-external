...
class BgpConfig(object):
    ...
    :type asn: 
    :param password: (:attr:`password`) BPG password
    :type password: 
    :param should_redistribute_routes: (:attr:`should_redistribute_routes`) Redistribute routes over eBGP. Applicable only to network gateways deployed on VLAN subnets with eBGP over VPN.  (**Default** False)
    :type should_redistribute_routes: 
    ...
    def __init__(self, asn=None, password=None, should_redistribute_routes=False, *args, **kwargs):  # noqa: E501
        self.__asn = None
        self.__password = None
        self.__should_redistribute_routes = None
        self.discriminator = None
        if asn is not None:
            self.__asn = asn
        if password is not None:
            self.__password = password
        if should_redistribute_routes is not None:
    ...
    @property
    def should_redistribute_routes(self):
        """
        ...
        :type:
                ...
                :class:`~bool`
        """  # noqa: E501
        return self.__should_redistribute_routes

    @should_redistribute_routes.setter
    def should_redistribute_routes(self, should_redistribute_routes):
