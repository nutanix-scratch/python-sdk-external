...
class ExporterProtocol(object):
    ...
    Allowed enum values:
        ...
        - _UNKNOWN
        - _REDACTED
        - TCP: TCP is used to export IPFIX messages.
        - UDP: UDP is used to export IPFIX messages.
    """
    _UNKNOWN = "$UNKNOWN"
    _REDACTED = "$REDACTED"
    TCP = "TCP"
        ...
        for attr in vars(self):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(ExporterProtocol, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ExporterProtocol):
            return False
