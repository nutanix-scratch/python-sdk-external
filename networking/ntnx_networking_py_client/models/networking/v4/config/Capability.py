...
class Capability(object):
    ...
    :param is_supported: (:attr:`is_supported`) Boolean - true if the capability is supported, false otherwise
    :type is_supported: required
    ...
    def __init__(self, capability_name=None, is_supported=None, *args, **kwargs):  # noqa: E501
        self.__capability_name = None
        self.__is_supported = None
    ...
    def capability_name(self):
        ...
        :type:
                ...
                :class:`~str`
        """  # noqa: E501
        return self.__capability_name

    @capability_name.setter
    def capability_name(self, capability_name):
        if capability_name is None:
            raise ValueError("Invalid value for `capability_name`, must not be `None`")  # noqa: E501
