...
from ntnx_networking_py_client.models.networking.v4.config.AwsConfig import AwsConfig  # noqa: F401,E501
...
class NetworkCloudConfig(NetworkingBaseModel):
    ...
    :type azure_config: 
    :param aws_config: (:attr:`aws_config`) 
    :type aws_config: 
    ...
    swagger_types = {
        ...
        'aws_config': 'networking.v4.config.AwsConfig',
    ...
    def __init__(self, azure_config=None, aws_config=None, metadata=None, ext_id=None, links=None, tenant_id=None, *args, **kwargs):  # noqa: E501
        NetworkingBaseModel.__init__(self, metadata, ext_id, links, tenant_id, *args, **kwargs)
        self.__azure_config = None
        self.__aws_config = None
    ...
    def aws_config(self):
        ...
        :type:
            :class:`~ntnx_networking_py_client.models.networking.v4.config.AwsConfig`
        """  # noqa: E501
