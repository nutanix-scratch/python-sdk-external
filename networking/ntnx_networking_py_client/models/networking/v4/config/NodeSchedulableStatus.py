...
class NodeSchedulableStatus(object):
    ...
    def __init__(self, ext_id=None, is_never_schedulable=None, *args, **kwargs):  # noqa: E501
        self.__ext_id = None
        self.__is_never_schedulable = None
    ...
    def is_never_schedulable(self):
        ...
        :type:
                ...
                :class:`~bool`
        """  # noqa: E501
        return self.__is_never_schedulable

    @is_never_schedulable.setter
    def is_never_schedulable(self, is_never_schedulable):
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(NodeSchedulableStatus, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, NodeSchedulableStatus):
            return False
