...
class AddressTypeObject(object):
    ...
    :type address_type: required
    :param subnet_prefix: (:attr:`subnet_prefix`) 
    :type subnet_prefix: 
    ...
    """  # noqa: E501
    swagger_types = {
        'address_type': 'networking.v4.config.AddressType',
        'subnet_prefix': 'networking.v4.config.IPSubnet',
    ...
    def __init__(self, address_type=None, subnet_prefix=None, *args, **kwargs):  # noqa: E501
        self.__address_type = None
        self.__subnet_prefix = None
    ...
    def address_type(self):
        ...
        :type:
            :class:`~ntnx_networking_py_client.models.networking.v4.config.AddressType`
        """  # noqa: E501
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(AddressTypeObject, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, AddressTypeObject):
            return False
