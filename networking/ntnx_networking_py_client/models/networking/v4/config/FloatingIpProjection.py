...
class FloatingIpProjection(FloatingIp):
    ...
    def __init__(self, subnet_projection=None, vm_nic_projection=None, vpc_projection=None, name=None, description=None, association=None, floating_ip=None, external_subnet_reference=None, external_subnet=None, private_ip=None, floating_ip_value=None, association_status=None, vpc_reference=None, vm_nic_reference=None, vpc=None, vm_nic=None, metadata=None, ext_id=None, links=None, tenant_id=None, *args, **kwargs):  # noqa: E501
        FloatingIp.__init__(self, name, description, association, floating_ip, external_subnet_reference, external_subnet, private_ip, floating_ip_value, association_status, vpc_reference, vm_nic_reference, vpc, vm_nic, metadata, ext_id, links, tenant_id, *args, **kwargs)
