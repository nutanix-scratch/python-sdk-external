...
class VpnAppliance(NetworkingBaseModel):
    ...
    :param name: (:attr:`name`) VPN appliance name.
    :type name: 
    :param version: (:attr:`version`) VPN appliance version.
    :type version: 
    ...
    def __init__(self, name=None, version=None, metadata=None, ext_id=None, links=None, tenant_id=None, *args, **kwargs):  # noqa: E501
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(VpnAppliance, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, VpnAppliance):
            return False
