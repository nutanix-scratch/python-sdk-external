...
class IpUnreserveSpec(object):
    ...
    :param count: (:attr:`count`) Number of IP addresses unreserved.
    :type count: 
    :param start_ip_address: (:attr:`start_ip_address`) 
    :type start_ip_address: 
    :param ip_addresses: (:attr:`ip_addresses`) 
    :type ip_addresses: 
    ...
    :type client_context: 
    :param unreserve_type: (:attr:`unreserve_type`) 
    :type unreserve_type: required
    ...
    swagger_types = {
        'count': 'int',
        'start_ip_address': 'common.v1.config.IPAddress',
        'ip_addresses': 'list[common.v1.config.IPAddress]',
        'client_context': 'str',
        'unreserve_type': 'networking.v4.config.UnreserveType',
    ...
    def __init__(self, count=None, start_ip_address=None, ip_addresses=None, client_context=None, unreserve_type=None, *args, **kwargs):  # noqa: E501
        self.__count = None
        self.__start_ip_address = None
        self.__ip_addresses = None
        self.__client_context = None
        self.__unreserve_type = None
        self.discriminator = None
        if count is not None:
            self.__count = count
        if start_ip_address is not None:
            self.__start_ip_address = start_ip_address
    ...
    @property
    def unreserve_type(self):
        """
        

        :type:
            :class:`~ntnx_networking_py_client.models.networking.v4.config.UnreserveType`
        """  # noqa: E501
        return self.__unreserve_type

    @unreserve_type.setter
    def unreserve_type(self, unreserve_type):
        if unreserve_type is None:
            raise ValueError("Invalid value for `unreserve_type`, must not be `None`")  # noqa: E501
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(IpUnreserveSpec, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, IpUnreserveSpec):
            return False
