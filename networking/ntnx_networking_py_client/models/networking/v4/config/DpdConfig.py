...
class DpdConfig(object):
    ...
    :type operation: 
    :param interval_secs: (:attr:`interval_secs`) The amount of time the peer waits for traffic before sending a DPD request 
    :type interval_secs: 
    :param timeout_secs: (:attr:`timeout_secs`) The maximum amount of time to wait for a DPD response before marking the peer as dead 
    :type timeout_secs: 
    ...
    """  # noqa: E501
    swagger_types = {
        'operation': 'networking.v4.config.DpdOperation',
        'interval_secs': 'int',
        'timeout_secs': 'int',
    ...
    def __init__(self, operation=None, interval_secs=None, timeout_secs=None, *args, **kwargs):  # noqa: E501
    ...
    def operation(self):
        ...
        :type:
            :class:`~ntnx_networking_py_client.models.networking.v4.config.DpdOperation`
        """  # noqa: E501
