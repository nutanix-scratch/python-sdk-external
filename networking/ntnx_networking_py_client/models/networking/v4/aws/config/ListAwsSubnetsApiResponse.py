...
from ntnx_networking_py_client.models.OneOfnetworking.v4.aws.config.ListAwsSubnetsApiResponsedata import ListAwsSubnetsApiResponsedata  # noqa: F401,E501
from ntnx_networking_py_client.models.common.v1.response.ApiResponseMetadata import ApiResponseMetadata  # noqa: F401,E501

class ListAwsSubnetsApiResponse(object):

    """REST response for all response codes in API path /networking/v4.0.b1/aws/config/subnets Get operation
    ...
    swagger_types = {
        ...
        'data': 'OneOfnetworking.v4.aws.config.ListAwsSubnetsApiResponsedata',
    ...
    def _initialize_object_type(self):
        return 'networking.v4.aws.config.ListAwsSubnetsApiResponse'
    ...
    def data(self):
        ...
        :type:
                :class:`~ntnx_networking_py_client.models.networking.v4.aws.config.AwsSubnet` | 
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(ListAwsSubnetsApiResponse, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ListAwsSubnetsApiResponse):
            return False
