...
class SubnetsApi(object):
    ...
    def list_aws_subnets(self, X_Cluster_Id, _filter=None, _orderby=None, _select=None, **kwargs):  # noqa: E501
        """Get NC2A subnets.

        >>> response = api.list_aws_subnets(X_Cluster_Id, (optional) _filter, (optional) _orderby, (optional) _select)

        This method makes a synchronous HTTP request by default. To make an asynchronous HTTP request, please pass async_req=True.

        >>> thread = api.list_aws_subnets(X_Cluster_Id, async_req=True)
        >>> result = thread.get()
        ...
        :type _orderby:
            ...
            :class:`str`
        :param _select: A URL query parameter that allows clients to request a specific set of properties for each entity or complex type. Expression specified with the $select must conform to the [OData V4.01](https://docs.oasis-open.org/odata/odata/v4.01/odata-v4.01-part1-protocol.html) URL conventions. If a $select expression consists of a single select item that is an asterisk (i.e., *), then all properties on the matching resource will be returned. - annotation - cidr - cloudType - gatewayIp - subnetId - vpcId 
        :type _select:
        ...
        :param kwargs: kwargs for the method.
                       The following can be passed for an asynchronous HTTP call::
                           ...
                           async_req=True
        :return: An instance of class :class:`~ntnx_networking_py_client.models.networking.v4.aws.config.ListAwsSubnetsApiResponse`.
        ...
        if ('X_Cluster_Id' not in params or params['X_Cluster_Id'] is None):
            raise ValueError("Missing the required parameter `X_Cluster_Id` when calling `list_aws_subnets`")  # noqa: E501
        ...
        extra_params.append('_preload_content')
        extra_params.append('_request_timeout')
        all_params = set(['X_Cluster_Id', '_filter', '_orderby', '_select'])
        all_params.update(extra_params)
        for key, val in six.iteritems(params):
            if val is not None and key.lower() not in self.__headers_to_skip and key not in all_params:
                if key.lower() == 'if_match'.lower():
        ...
        try:
            if kwargs.get('async_req'):
                return self.api_client._call_api(
                    '/api/networking/v4.0.b1/aws/config/subnets', 'GET',
                    path_params,
                    query_params,
                    header_params,
                    body=body_params,
                    post_params=form_params,
                    files=local_var_files,
                    response_type='networking.v4.aws.config.ListAwsSubnetsApiResponse',  # noqa: E501
                    auth_settings=auth_settings,
                    async_req=params.get('async_req'),
                    _return_http_data_only=params.get('_return_http_data_only'),
                    _preload_content=params.get('_preload_content', True),
