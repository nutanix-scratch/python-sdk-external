...
class Configuration(six.with_metaclass(TypeWithDefault, object)):
    """A class for the configuration of :class:`~ntnx_networking_py_client.api_client.ApiClient`.
    ...
    def __init__(self):
        ...
        # Logging Settings
        self.logger = {}
        self.logger["package_logger"] = logging.getLogger("ntnx_networking_py_client")
        # Log format
